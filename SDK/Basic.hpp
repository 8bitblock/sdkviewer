...
namespace Offsets
{
	constexpr int32 GObjects          = 0x06B99F30;
	constexpr int32 AppendString      = 0x021072C0;
	constexpr int32 GNames            = 0x06B5D8C0;
	constexpr int32 GWorld            = 0x068FE4A8;
	constexpr int32 ProcessEvent      = 0x0235AC70;
