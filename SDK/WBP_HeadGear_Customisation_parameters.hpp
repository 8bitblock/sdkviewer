...
public:
	...
	struct FGameplayTagContainer                  CallFunc_GetInvItemTags_ReturnValue;               // 0x0008(0x0020)()
	TArray<struct FPrimaryAssetId>                CallFunc_GetInvItemAssetIds_OutItemAssetIds;       // 0x0028(0x0010)(ReferenceParm)
	...
	struct FPrimaryAssetId                        CallFunc_GetSimilarInvItemSkinId_ReturnValue;      // 0x0040(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_HeadGear_Customisation_C_ShouldAddCounterWeight) == 0x000050, "Wrong size on WBP_HeadGear_Customisation_C_ShouldAddCounterWeight");
...
static_assert(offsetof(WBP_HeadGear_Customisation_C_ShouldAddCounterWeight, CallFunc_GetInvItemTags_ReturnValue) == 0x000008, "Member 'WBP_HeadGear_Customisation_C_ShouldAddCounterWeight::CallFunc_GetInvItemTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_HeadGear_Customisation_C_ShouldAddCounterWeight, CallFunc_GetInvItemAssetIds_OutItemAssetIds) == 0x000028, "Member 'WBP_HeadGear_Customisation_C_ShouldAddCounterWeight::CallFunc_GetInvItemAssetIds_OutItemAssetIds' has a wrong offset!");
static_assert(offsetof(WBP_HeadGear_Customisation_C_ShouldAddCounterWeight, CallFunc_Array_Length_ReturnValue) == 0x000038, "Member 'WBP_HeadGear_Customisation_C_ShouldAddCounterWeight::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_HeadGear_Customisation_C_ShouldAddCounterWeight, CallFunc_Greater_IntInt_ReturnValue) == 0x00003C, "Member 'WBP_HeadGear_Customisation_C_ShouldAddCounterWeight::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_HeadGear_Customisation_C_ShouldAddCounterWeight, CallFunc_GetSimilarInvItemSkinId_ReturnValue) == 0x000040, "Member 'WBP_HeadGear_Customisation_C_ShouldAddCounterWeight::CallFunc_GetSimilarInvItemSkinId_ReturnValue' has a wrong offset!");
