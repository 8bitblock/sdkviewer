...
public:
	...
	float                                         CachedSightLineToEyeAlpha;                         // 0x073C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(URIG_AimAndCollision_C, CachedSightLineToEyeAlpha) == 0x00073C, "Member 'URIG_AimAndCollision_C::CachedSightLineToEyeAlpha' has a wrong offset!");
