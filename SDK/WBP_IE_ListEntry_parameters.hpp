...
public:
	...
	bool                                          CallFunc_HasTag_ReturnValue;                       // 0x0015(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_16[0x2];                                       // 0x0016(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UGBPouchDragDropPayload*                K2Node_DynamicCast_AsGBPouch_Drag_Drop_Payload;    // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  CallFunc_GetInvItemTags_ReturnValue;               // 0x0028(0x0020)()
	TDelegate<void(bool bApplyToChildren)>        K2Node_CreateDelegate_OutputDelegate_1;            // 0x0048(0x0010)(ZeroConstructor, NoDestructor)
	...
	class UGBInvItemDragDropPayload*              K2Node_DynamicCast_AsGBInv_Item_Drag_Drop_Payload; // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_89[0x3];                                       // 0x0089(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate_3;            // 0x008C(0x0010)(ZeroConstructor, NoDestructor)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_IE_List_C*                         CallFunc_GetParentWidgetOfClass_ReturnValue;       // 0x00A0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FPrimaryAssetId                        K2Node_ComponentBoundEvent_SkinId;                 // 0x00A8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWBP_InvItemEditor_C*                   CallFunc_GetParentWidgetOfClass_ReturnValue_1;     // 0x00B8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_CustomEvent_bApplyToChildren;               // 0x00C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x00C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsHovered_ReturnValue;                    // 0x00C2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UClass*                                 K2Node_ClassDynamicCast_AsGBInv_Item_Drag_Drop_Operation; // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_ClassDynamicCast_bSuccess;                  // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_HasTag_ReturnValue_1;                     // 0x00D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_IsOpen_ReturnValue;                       // 0x00F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry) == 0x000108, "Wrong size on WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry");
...
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_HasTag_ReturnValue) == 0x000015, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_HasTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_DynamicCast_AsGBPouch_Drag_Drop_Payload) == 0x000018, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_DynamicCast_AsGBPouch_Drag_Drop_Payload' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_GetInvItemTags_ReturnValue) == 0x000028, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_GetInvItemTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_CreateDelegate_OutputDelegate_1) == 0x000048, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_CreateDelegate_OutputDelegate_2) == 0x000058, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000068, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_Event_bIsExpanded) == 0x000070, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_Event_bIsExpanded' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_Event_bIsSelected) == 0x000071, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_Event_bIsSelected' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_Event_ListItemObject) == 0x000078, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_Event_ListItemObject' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_DynamicCast_AsGBInv_Item_Drag_Drop_Payload) == 0x000080, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_DynamicCast_AsGBInv_Item_Drag_Drop_Payload' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_DynamicCast_bSuccess_1) == 0x000088, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_CreateDelegate_OutputDelegate_3) == 0x00008C, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_GetParentWidgetOfClass_ReturnValue) == 0x0000A0, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_GetParentWidgetOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_ComponentBoundEvent_SkinId) == 0x0000A8, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_ComponentBoundEvent_SkinId' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_GetParentWidgetOfClass_ReturnValue_1) == 0x0000B8, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_GetParentWidgetOfClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_CustomEvent_bApplyToChildren) == 0x0000C0, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_CustomEvent_bApplyToChildren' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_Not_PreBool_ReturnValue) == 0x0000C1, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_IsHovered_ReturnValue) == 0x0000C2, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_IsHovered_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_Not_PreBool_ReturnValue_1) == 0x0000C3, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, Temp_class_Variable) == 0x0000C8, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::Temp_class_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_ClassDynamicCast_AsGBInv_Item_Drag_Drop_Operation) == 0x0000D0, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_ClassDynamicCast_AsGBInv_Item_Drag_Drop_Operation' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_ClassDynamicCast_bSuccess) == 0x0000D8, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_ClassDynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_HasTag_ReturnValue_1) == 0x0000D9, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_HasTag_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_CustomEvent_Loaded) == 0x0000E0, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_CustomEvent_Loaded' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, Temp_object_Variable) == 0x0000E8, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_DynamicCast_AsTexture_2D) == 0x0000F0, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_DynamicCast_AsTexture_2D' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_DynamicCast_bSuccess_2) == 0x0000F8, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, CallFunc_IsOpen_ReturnValue) == 0x0000F9, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::CallFunc_IsOpen_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry, K2Node_CustomEvent_Loaded_1) == 0x000100, "Member 'WBP_IE_ListEntry_C_ExecuteUbergraph_WBP_IE_ListEntry::K2Node_CustomEvent_Loaded_1' has a wrong offset!");
