...
public:
	...
	class UAnimMontage*                           WatchCheckProne;                                   // 0x0010(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer) == 0x000028, "Wrong size on ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer");
...
static_assert(offsetof(ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer, WatchCheckProne) == 0x000010, "Member 'ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer::WatchCheckProne' has a wrong offset!");
static_assert(offsetof(ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer, K2Node_SwitchName_CmpSuccess) == 0x000018, "Member 'ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer::K2Node_SwitchName_CmpSuccess' has a wrong offset!");
static_assert(offsetof(ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer, Temp_bool_Variable) == 0x000019, "Member 'ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer, CallFunc_IsValid_ReturnValue) == 0x00001A, "Member 'ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer, CallFunc_Greater_FloatFloat_ReturnValue) == 0x00001B, "Member 'ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer::CallFunc_Greater_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer, K2Node_Select_Default) == 0x000020, "Member 'ABP_Handgun_AnimLayerBase_C_GetMontageFromLinkedLayer::K2Node_Select_Default' has a wrong offset!");
