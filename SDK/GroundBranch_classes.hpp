...
public:
	...
	void K2_BlockAbilitiesWithTags(const struct FGameplayTagContainer& Tags);
	void K2_UnBlockAbilitiesWithTags(const struct FGameplayTagContainer& Tags);
...
public:
	...
	static struct FPrimaryAssetId GetFirstValidInvItemSkinId(const class FName& ProfileName, const struct FGameplayTagContainer& InvItemTags);
	...
	static struct FPrimaryAssetId GetSimilarInvItemSkinId(const class FName& ProfileName, const struct FGameplayTagContainer& InvItemTags, const struct FGameplayTag& InvItemSkinNameTag, const struct FGameplayTagContainer& SubstituteInvItemSkinNameTags);
	static struct FPrimaryAssetId GetSimilarInvItemSkinIdToExisting(const class FName& ProfileName, const struct FGameplayTagContainer& InvItemTags, const struct FPrimaryAssetId& ExistingInvItemSkinId);
	static struct FGameplayTagContainer GetSubstituteInvItemSkinNameTags(const struct FGameplayTag& InvItemSkinNameTag);
	static TArray<struct FPrimaryAssetId> GetValidInvItemSkinIds(const class FName& ProfileName, const struct FGameplayTagContainer& InvItemTags);
	...
	static bool RestrictedInvItem(const class FName& ProfileName, const struct FGameplayTagContainer& InvItemTags);
	static bool RestrictedInvItemSkin(const class FName& ProfileName, const struct FGameplayTagContainer& InvItemTags, const struct FGameplayTagContainer& InvItemSkinTags);
...
public:
	...
	void AdminRequest(const class FName& RequestType, const class FString& Params_0, TDelegate<void(const struct FZKReplicatedContent& Content)> OnAdminRequestFilled);
	void AdminSet(const class FString& Params_0, const struct FZKReplicatedContent& Content);
	bool BP_IsFrozen();
	void BP_ReadyRoom();
	void BP_Spectate();
	void BulletWarn(class AActor* Bullet, bool bSubSonic);
	...
	void Server_CustomTraceBookmark();
	void ServerAdmin(const class FString& Parameters);
	void ServerAdminRequest(const class FName& RequestType, const class FString& Params_0);
	void ServerAdminSet(const class FString& Params_0, const struct FZKReplicatedContent& Content);
...
public:
	...
	void SpawnDebugBot(uint8 TeamId);
...
public:
	...
	float                                         MinSightRelativeX;                                 // 0x0548(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MaxGripRelativeX;                                  // 0x054C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                CollisionTraceEndOffset;                           // 0x0550(0x000C)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_55C[0xC];                                      // 0x055C(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AGBFirearm, MinSightRelativeX) == 0x000548, "Member 'AGBFirearm::MinSightRelativeX' has a wrong offset!");
static_assert(offsetof(AGBFirearm, MaxGripRelativeX) == 0x00054C, "Member 'AGBFirearm::MaxGripRelativeX' has a wrong offset!");
static_assert(offsetof(AGBFirearm, CollisionTraceEndOffset) == 0x000550, "Member 'AGBFirearm::CollisionTraceEndOffset' has a wrong offset!");
...
public:
	...
	TArray<struct FGBReplicatedString>            PlayerLoadoutInfo;                                 // 0x0438(0x0010)(Net, ZeroConstructor, Transient, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(AGBGameState, PlayerLoadoutInfo) == 0x000438, "Member 'AGBGameState::PlayerLoadoutInfo' has a wrong offset!");
...
public:
	...
	static void ValidateOrReplaceInvItemSkin(const class FName& ProfileName, const struct FGameplayTagContainer& InvItemTags, const struct FPrimaryAssetId& DesiredInvItemSkinId, const class AGBCharacter* Character, struct FPrimaryAssetId* OutValidInvItemSkinId);
...
class UGBPatchGeneratorWidget : public UUserWidget
{
public:
...
// Class GroundBranch.GBRestrictionEntryLibrary
// 0x0000 (0x0028 - 0x0028)
class UGBRestrictionEntryLibrary final : public UBlueprintFunctionLibrary
{
public:
	static class FString RestrictionEntryArrayToJsonString(const TArray<struct FGBRestrictionEntry>& Entries);
	static struct FGBRestrictionEntry RestrictionEntryFromJsonString(const class FString& JsonString);
	static class FString RestrictionEntryToJsonString(const struct FGBRestrictionEntry& Entry);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GBRestrictionEntryLibrary">();
	}
	static class UGBRestrictionEntryLibrary* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGBRestrictionEntryLibrary>();
	}
};
static_assert(alignof(UGBRestrictionEntryLibrary) == 0x000008, "Wrong alignment on UGBRestrictionEntryLibrary");
static_assert(sizeof(UGBRestrictionEntryLibrary) == 0x000028, "Wrong size on UGBRestrictionEntryLibrary");
