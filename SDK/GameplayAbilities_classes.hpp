...
public:
	...
	struct FMinimalReplicationTagCountMap         ReplicatedLooseTags;                               // 0x11E8(0x0060)(Net, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1248[0x8];                                     // 0x1248(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FReplicatedPredictionKeyMap            ReplicatedPredictionKeyMap;                        // 0x1250(0x0118)(Net, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAbilitySystemComponent) == 0x001368, "Wrong size on UAbilitySystemComponent");
...
static_assert(offsetof(UAbilitySystemComponent, ReplicatedLooseTags) == 0x0011E8, "Member 'UAbilitySystemComponent::ReplicatedLooseTags' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ReplicatedPredictionKeyMap) == 0x001250, "Member 'UAbilitySystemComponent::ReplicatedPredictionKeyMap' has a wrong offset!");
