...
static_assert(sizeof(FRigControlValueStorage) == 0x000044, "Wrong size on FRigControlValueStorage");
...
static_assert(offsetof(FRigControlValueStorage, bValid) == 0x000040, "Member 'FRigControlValueStorage::bValid' has a wrong offset!");
...
static_assert(sizeof(FRigControl) == 0x0002F0, "Wrong size on FRigControl");
...
static_assert(offsetof(FRigControl, InitialValue) == 0x000070, "Member 'FRigControl::InitialValue' has a wrong offset!");
static_assert(offsetof(FRigControl, Value) == 0x0000F0, "Member 'FRigControl::Value' has a wrong offset!");
static_assert(offsetof(FRigControl, PrimaryAxis) == 0x000170, "Member 'FRigControl::PrimaryAxis' has a wrong offset!");
static_assert(offsetof(FRigControl, bIsCurve) == 0x000171, "Member 'FRigControl::bIsCurve' has a wrong offset!");
static_assert(offsetof(FRigControl, bAnimatable) == 0x000172, "Member 'FRigControl::bAnimatable' has a wrong offset!");
static_assert(offsetof(FRigControl, bLimitTranslation) == 0x000173, "Member 'FRigControl::bLimitTranslation' has a wrong offset!");
static_assert(offsetof(FRigControl, bLimitRotation) == 0x000174, "Member 'FRigControl::bLimitRotation' has a wrong offset!");
static_assert(offsetof(FRigControl, bLimitScale) == 0x000175, "Member 'FRigControl::bLimitScale' has a wrong offset!");
static_assert(offsetof(FRigControl, bDrawLimits) == 0x000176, "Member 'FRigControl::bDrawLimits' has a wrong offset!");
static_assert(offsetof(FRigControl, MinimumValue) == 0x000180, "Member 'FRigControl::MinimumValue' has a wrong offset!");
static_assert(offsetof(FRigControl, MaximumValue) == 0x000200, "Member 'FRigControl::MaximumValue' has a wrong offset!");
static_assert(offsetof(FRigControl, bGizmoEnabled) == 0x000280, "Member 'FRigControl::bGizmoEnabled' has a wrong offset!");
static_assert(offsetof(FRigControl, bGizmoVisible) == 0x000281, "Member 'FRigControl::bGizmoVisible' has a wrong offset!");
static_assert(offsetof(FRigControl, GizmoName) == 0x000284, "Member 'FRigControl::GizmoName' has a wrong offset!");
static_assert(offsetof(FRigControl, GizmoTransform) == 0x000290, "Member 'FRigControl::GizmoTransform' has a wrong offset!");
static_assert(offsetof(FRigControl, GizmoColor) == 0x0002C0, "Member 'FRigControl::GizmoColor' has a wrong offset!");
static_assert(offsetof(FRigControl, Dependents) == 0x0002D0, "Member 'FRigControl::Dependents' has a wrong offset!");
...
static_assert(alignof(FRigUnit_TwistBones) == 0x000008, "Wrong alignment on FRigUnit_TwistBones");
static_assert(sizeof(FRigUnit_TwistBones) == 0x0000D0, "Wrong size on FRigUnit_TwistBones");
static_assert(offsetof(FRigUnit_TwistBones, StartBone) == 0x000068, "Member 'FRigUnit_TwistBones::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBones, EndBone) == 0x000070, "Member 'FRigUnit_TwistBones::EndBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBones, TwistAxis) == 0x000078, "Member 'FRigUnit_TwistBones::TwistAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBones, PoleAxis) == 0x000084, "Member 'FRigUnit_TwistBones::PoleAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBones, TwistEaseType) == 0x000090, "Member 'FRigUnit_TwistBones::TwistEaseType' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBones, Weight) == 0x000094, "Member 'FRigUnit_TwistBones::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBones, bPropagateToChildren) == 0x000098, "Member 'FRigUnit_TwistBones::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBones, WorkData) == 0x0000A0, "Member 'FRigUnit_TwistBones::WorkData' has a wrong offset!");
...
static_assert(alignof(FRigUnit_ModifyTransforms) == 0x000008, "Wrong alignment on FRigUnit_ModifyTransforms");
static_assert(sizeof(FRigUnit_ModifyTransforms) == 0x000098, "Wrong size on FRigUnit_ModifyTransforms");
static_assert(offsetof(FRigUnit_ModifyTransforms, ItemToModify) == 0x000068, "Member 'FRigUnit_ModifyTransforms::ItemToModify' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyTransforms, Weight) == 0x000078, "Member 'FRigUnit_ModifyTransforms::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyTransforms, WeightMinimum) == 0x00007C, "Member 'FRigUnit_ModifyTransforms::WeightMinimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyTransforms, WeightMaximum) == 0x000080, "Member 'FRigUnit_ModifyTransforms::WeightMaximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyTransforms, Mode) == 0x000084, "Member 'FRigUnit_ModifyTransforms::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyTransforms, WorkData) == 0x000088, "Member 'FRigUnit_ModifyTransforms::WorkData' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ControlRig) == 0x000368, "Wrong size on FAnimNode_ControlRig");
...
static_assert(sizeof(FRigUnit_ModifyBoneTransforms) == 0x000098, "Wrong size on FRigUnit_ModifyBoneTransforms");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, BoneToModify) == 0x000068, "Member 'FRigUnit_ModifyBoneTransforms::BoneToModify' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, Weight) == 0x000078, "Member 'FRigUnit_ModifyBoneTransforms::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, WeightMinimum) == 0x00007C, "Member 'FRigUnit_ModifyBoneTransforms::WeightMinimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, WeightMaximum) == 0x000080, "Member 'FRigUnit_ModifyBoneTransforms::WeightMaximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, Mode) == 0x000084, "Member 'FRigUnit_ModifyBoneTransforms::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_ModifyBoneTransforms, WorkData) == 0x000088, "Member 'FRigUnit_ModifyBoneTransforms::WorkData' has a wrong offset!");
...
static_assert(sizeof(FControlRigComponentMappedElement) == 0x0000A0, "Wrong size on FControlRigComponentMappedElement");
...
static_assert(offsetof(FControlRigComponentMappedElement, Weight) == 0x000080, "Member 'FControlRigComponentMappedElement::Weight' has a wrong offset!");
static_assert(offsetof(FControlRigComponentMappedElement, Space) == 0x000084, "Member 'FControlRigComponentMappedElement::Space' has a wrong offset!");
static_assert(offsetof(FControlRigComponentMappedElement, SceneComponent) == 0x000088, "Member 'FControlRigComponentMappedElement::SceneComponent' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SimBaseMutable) == 0x000068, "Wrong size on FRigUnit_SimBaseMutable");
...
static_assert(sizeof(FControlRigDrawInstruction) == 0x0000A0, "Wrong size on FControlRigDrawInstruction");
...
static_assert(alignof(FGizmoActorCreationParam) == 0x000010, "Wrong alignment on FGizmoActorCreationParam");
static_assert(sizeof(FGizmoActorCreationParam) == 0x000120, "Wrong size on FGizmoActorCreationParam");
...
static_assert(sizeof(FRigPoseElement) == 0x000090, "Wrong size on FRigPoseElement");
...
static_assert(offsetof(FRigPoseElement, LocalTransform) == 0x000050, "Member 'FRigPoseElement::LocalTransform' has a wrong offset!");
static_assert(offsetof(FRigPoseElement, CurveValue) == 0x000080, "Member 'FRigPoseElement::CurveValue' has a wrong offset!");
...
{
public:
	uint8                                         Pad_A10[0x2B0];                                    // 0x0A10(0x02B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FChannelMapInfo) == 0x000018, "Wrong size on FChannelMapInfo");
...
static_assert(sizeof(FRigUnit_SetBoneTranslation) == 0x0000A0, "Wrong size on FRigUnit_SetBoneTranslation");
static_assert(offsetof(FRigUnit_SetBoneTranslation, Bone) == 0x000068, "Member 'FRigUnit_SetBoneTranslation::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, Translation) == 0x000070, "Member 'FRigUnit_SetBoneTranslation::Translation' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, Space) == 0x00007C, "Member 'FRigUnit_SetBoneTranslation::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, Weight) == 0x000080, "Member 'FRigUnit_SetBoneTranslation::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, bPropagateToChildren) == 0x000084, "Member 'FRigUnit_SetBoneTranslation::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneTranslation, CachedBone) == 0x000088, "Member 'FRigUnit_SetBoneTranslation::CachedBone' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_MultiFABRIK) == 0x0000F0, "Wrong size on FRigUnit_MultiFABRIK");
static_assert(offsetof(FRigUnit_MultiFABRIK, RootBone) == 0x000068, "Member 'FRigUnit_MultiFABRIK::RootBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_MultiFABRIK, Effectors) == 0x000070, "Member 'FRigUnit_MultiFABRIK::Effectors' has a wrong offset!");
static_assert(offsetof(FRigUnit_MultiFABRIK, Precision) == 0x000080, "Member 'FRigUnit_MultiFABRIK::Precision' has a wrong offset!");
static_assert(offsetof(FRigUnit_MultiFABRIK, bPropagateToChildren) == 0x000084, "Member 'FRigUnit_MultiFABRIK::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_MultiFABRIK, MaxIterations) == 0x000088, "Member 'FRigUnit_MultiFABRIK::MaxIterations' has a wrong offset!");
static_assert(offsetof(FRigUnit_MultiFABRIK, WorkData) == 0x000090, "Member 'FRigUnit_MultiFABRIK::WorkData' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_OffsetTransformForItem) == 0x0000D0, "Wrong size on FRigUnit_OffsetTransformForItem");
static_assert(offsetof(FRigUnit_OffsetTransformForItem, Item) == 0x000068, "Member 'FRigUnit_OffsetTransformForItem::Item' has a wrong offset!");
static_assert(offsetof(FRigUnit_OffsetTransformForItem, OffsetTransform) == 0x000080, "Member 'FRigUnit_OffsetTransformForItem::OffsetTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_OffsetTransformForItem, Weight) == 0x0000B0, "Member 'FRigUnit_OffsetTransformForItem::Weight' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_ProjectTransformToNewParent) == 0x0000B0, "Wrong size on FRigUnit_ProjectTransformToNewParent");
...
static_assert(offsetof(FRigUnit_ProjectTransformToNewParent, CachedChild) == 0x000070, "Member 'FRigUnit_ProjectTransformToNewParent::CachedChild' has a wrong offset!");
static_assert(offsetof(FRigUnit_ProjectTransformToNewParent, CachedOldParent) == 0x000084, "Member 'FRigUnit_ProjectTransformToNewParent::CachedOldParent' has a wrong offset!");
static_assert(offsetof(FRigUnit_ProjectTransformToNewParent, CachedNewParent) == 0x000098, "Member 'FRigUnit_ProjectTransformToNewParent::CachedNewParent' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_EndProfilingTimer) == 0x000088, "Wrong size on FRigUnit_EndProfilingTimer");
static_assert(offsetof(FRigUnit_EndProfilingTimer, NumberOfMeasurements) == 0x000068, "Member 'FRigUnit_EndProfilingTimer::NumberOfMeasurements' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_AddBoneTransform) == 0x0000C0, "Wrong size on FRigUnit_AddBoneTransform");
static_assert(offsetof(FRigUnit_AddBoneTransform, Bone) == 0x000068, "Member 'FRigUnit_AddBoneTransform::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_AddBoneTransform, Transform) == 0x000070, "Member 'FRigUnit_AddBoneTransform::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_AddBoneTransform, Weight) == 0x0000A0, "Member 'FRigUnit_AddBoneTransform::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_AddBoneTransform, bPostMultiply) == 0x0000A4, "Member 'FRigUnit_AddBoneTransform::bPostMultiply' has a wrong offset!");
static_assert(offsetof(FRigUnit_AddBoneTransform, bPropagateToChildren) == 0x0000A5, "Member 'FRigUnit_AddBoneTransform::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_AddBoneTransform, CachedBone) == 0x0000A8, "Member 'FRigUnit_AddBoneTransform::CachedBone' has a wrong offset!");
...
static_assert(alignof(FRigUnit_AimItem_Target) == 0x000004, "Wrong alignment on FRigUnit_AimItem_Target");
static_assert(sizeof(FRigUnit_AimItem_Target) == 0x00002C, "Wrong size on FRigUnit_AimItem_Target");
static_assert(offsetof(FRigUnit_AimItem_Target, Weight) == 0x000000, "Member 'FRigUnit_AimItem_Target::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem_Target, Axis) == 0x000004, "Member 'FRigUnit_AimItem_Target::Axis' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem_Target, Target) == 0x000010, "Member 'FRigUnit_AimItem_Target::Target' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem_Target, Kind) == 0x00001C, "Member 'FRigUnit_AimItem_Target::Kind' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem_Target, Space) == 0x000020, "Member 'FRigUnit_AimItem_Target::Space' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_AimItem) == 0x000150, "Wrong size on FRigUnit_AimItem");
static_assert(offsetof(FRigUnit_AimItem, Item) == 0x000068, "Member 'FRigUnit_AimItem::Item' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem, Primary) == 0x000074, "Member 'FRigUnit_AimItem::Primary' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem, Secondary) == 0x0000A0, "Member 'FRigUnit_AimItem::Secondary' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem, Weight) == 0x0000CC, "Member 'FRigUnit_AimItem::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem, DebugSettings) == 0x0000D0, "Member 'FRigUnit_AimItem::DebugSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem, CachedItem) == 0x000110, "Member 'FRigUnit_AimItem::CachedItem' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem, PrimaryCachedSpace) == 0x000124, "Member 'FRigUnit_AimItem::PrimaryCachedSpace' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimItem, SecondaryCachedSpace) == 0x000138, "Member 'FRigUnit_AimItem::SecondaryCachedSpace' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_AimBone) == 0x000150, "Wrong size on FRigUnit_AimBone");
static_assert(offsetof(FRigUnit_AimBone, Bone) == 0x000068, "Member 'FRigUnit_AimBone::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, Primary) == 0x000070, "Member 'FRigUnit_AimBone::Primary' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, Secondary) == 0x000098, "Member 'FRigUnit_AimBone::Secondary' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, Weight) == 0x0000C0, "Member 'FRigUnit_AimBone::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, bPropagateToChildren) == 0x0000C4, "Member 'FRigUnit_AimBone::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, DebugSettings) == 0x0000D0, "Member 'FRigUnit_AimBone::DebugSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBone, CachedBoneIndex) == 0x000110, "Member 'FRigUnit_AimBone::CachedBoneIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_AimBoneMath) == 0x000140, "Wrong size on FRigUnit_AimBoneMath");
...
static_assert(offsetof(FRigUnit_AimBoneMath, Primary) == 0x000040, "Member 'FRigUnit_AimBoneMath::Primary' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBoneMath, Secondary) == 0x00006C, "Member 'FRigUnit_AimBoneMath::Secondary' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBoneMath, Weight) == 0x000098, "Member 'FRigUnit_AimBoneMath::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBoneMath, Result) == 0x0000A0, "Member 'FRigUnit_AimBoneMath::Result' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimBoneMath, DebugSettings) == 0x0000D0, "Member 'FRigUnit_AimBoneMath::DebugSettings' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SetControlVector2D) == 0x000090, "Wrong size on FRigUnit_SetControlVector2D");
static_assert(offsetof(FRigUnit_SetControlVector2D, Control) == 0x000068, "Member 'FRigUnit_SetControlVector2D::Control' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlVector2D, Weight) == 0x000070, "Member 'FRigUnit_SetControlVector2D::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlVector2D, Vector) == 0x000074, "Member 'FRigUnit_SetControlVector2D::Vector' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlVector2D, CachedControlIndex) == 0x00007C, "Member 'FRigUnit_SetControlVector2D::CachedControlIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_AimConstraint) == 0x0000C0, "Wrong size on FRigUnit_AimConstraint");
static_assert(offsetof(FRigUnit_AimConstraint, Joint) == 0x000068, "Member 'FRigUnit_AimConstraint::Joint' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, AimMode) == 0x000070, "Member 'FRigUnit_AimConstraint::AimMode' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, UpMode) == 0x000071, "Member 'FRigUnit_AimConstraint::UpMode' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, AimVector) == 0x000074, "Member 'FRigUnit_AimConstraint::AimVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, UpVector) == 0x000080, "Member 'FRigUnit_AimConstraint::UpVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_AimConstraint, AimTargets) == 0x000090, "Member 'FRigUnit_AimConstraint::AimTargets' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SetBoneRotation) == 0x0000A0, "Wrong size on FRigUnit_SetBoneRotation");
static_assert(offsetof(FRigUnit_SetBoneRotation, Bone) == 0x000068, "Member 'FRigUnit_SetBoneRotation::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneRotation, Rotation) == 0x000070, "Member 'FRigUnit_SetBoneRotation::Rotation' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetBoneRotation, Space) == 0x000080, "Member 'FRigUnit_SetBoneRotation::Space' has a wrong offset!");
...
static_assert(alignof(FRigUnit_SetMultiControlVector2D) == 0x000008, "Wrong alignment on FRigUnit_SetMultiControlVector2D");
static_assert(sizeof(FRigUnit_SetMultiControlVector2D) == 0x000090, "Wrong size on FRigUnit_SetMultiControlVector2D");
static_assert(offsetof(FRigUnit_SetMultiControlVector2D, Entries) == 0x000068, "Member 'FRigUnit_SetMultiControlVector2D::Entries' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetMultiControlVector2D, Weight) == 0x000078, "Member 'FRigUnit_SetMultiControlVector2D::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetMultiControlVector2D, CachedControlIndices) == 0x000080, "Member 'FRigUnit_SetMultiControlVector2D::CachedControlIndices' has a wrong offset!");
...
static_assert(alignof(FRigUnit_SetControlVisibility) == 0x000008, "Wrong alignment on FRigUnit_SetControlVisibility");
static_assert(sizeof(FRigUnit_SetControlVisibility) == 0x0000A0, "Wrong size on FRigUnit_SetControlVisibility");
static_assert(offsetof(FRigUnit_SetControlVisibility, Item) == 0x000068, "Member 'FRigUnit_SetControlVisibility::Item' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlVisibility, Pattern) == 0x000078, "Member 'FRigUnit_SetControlVisibility::Pattern' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlVisibility, bVisible) == 0x000088, "Member 'FRigUnit_SetControlVisibility::bVisible' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlVisibility, CachedControlIndices) == 0x000090, "Member 'FRigUnit_SetControlVisibility::CachedControlIndices' has a wrong offset!");
...
static_assert(alignof(FRigUnit_SetMultiControlFloat) == 0x000008, "Wrong alignment on FRigUnit_SetMultiControlFloat");
static_assert(sizeof(FRigUnit_SetMultiControlFloat) == 0x000090, "Wrong size on FRigUnit_SetMultiControlFloat");
static_assert(offsetof(FRigUnit_SetMultiControlFloat, Entries) == 0x000068, "Member 'FRigUnit_SetMultiControlFloat::Entries' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetMultiControlFloat, Weight) == 0x000078, "Member 'FRigUnit_SetMultiControlFloat::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetMultiControlFloat, CachedControlIndices) == 0x000080, "Member 'FRigUnit_SetMultiControlFloat::CachedControlIndices' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SetSpaceInitialTransform) == 0x0000F0, "Wrong size on FRigUnit_SetSpaceInitialTransform");
static_assert(offsetof(FRigUnit_SetSpaceInitialTransform, SpaceName) == 0x000068, "Member 'FRigUnit_SetSpaceInitialTransform::SpaceName' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetSpaceInitialTransform, Transform) == 0x000070, "Member 'FRigUnit_SetSpaceInitialTransform::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetSpaceInitialTransform, Result) == 0x0000A0, "Member 'FRigUnit_SetSpaceInitialTransform::Result' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetSpaceInitialTransform, Space) == 0x0000D0, "Member 'FRigUnit_SetSpaceInitialTransform::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetSpaceInitialTransform, CachedSpaceIndex) == 0x0000D4, "Member 'FRigUnit_SetSpaceInitialTransform::CachedSpaceIndex' has a wrong offset!");
...
static_assert(alignof(FRigUnit_ItemHarmonics) == 0x000008, "Wrong alignment on FRigUnit_ItemHarmonics");
static_assert(sizeof(FRigUnit_ItemHarmonics) == 0x0000E8, "Wrong size on FRigUnit_ItemHarmonics");
static_assert(offsetof(FRigUnit_ItemHarmonics, Targets) == 0x000068, "Member 'FRigUnit_ItemHarmonics::Targets' has a wrong offset!");
static_assert(offsetof(FRigUnit_ItemHarmonics, WaveSpeed) == 0x000078, "Member 'FRigUnit_ItemHarmonics::WaveSpeed' has a wrong offset!");
static_assert(offsetof(FRigUnit_ItemHarmonics, WaveFrequency) == 0x000084, "Member 'FRigUnit_ItemHarmonics::WaveFrequency' has a wrong offset!");
static_assert(offsetof(FRigUnit_ItemHarmonics, WaveAmplitude) == 0x000090, "Member 'FRigUnit_ItemHarmonics::WaveAmplitude' has a wrong offset!");
static_assert(offsetof(FRigUnit_ItemHarmonics, WaveOffset) == 0x00009C, "Member 'FRigUnit_ItemHarmonics::WaveOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_ItemHarmonics, WaveNoise) == 0x0000A8, "Member 'FRigUnit_ItemHarmonics::WaveNoise' has a wrong offset!");
static_assert(offsetof(FRigUnit_ItemHarmonics, WaveEase) == 0x0000B4, "Member 'FRigUnit_ItemHarmonics::WaveEase' has a wrong offset!");
static_assert(offsetof(FRigUnit_ItemHarmonics, WaveMinimum) == 0x0000B8, "Member 'FRigUnit_ItemHarmonics::WaveMinimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ItemHarmonics, WaveMaximum) == 0x0000BC, "Member 'FRigUnit_ItemHarmonics::WaveMaximum' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_BoneHarmonics) == 0x0000E8, "Wrong size on FRigUnit_BoneHarmonics");
static_assert(offsetof(FRigUnit_BoneHarmonics, Bones) == 0x000068, "Member 'FRigUnit_BoneHarmonics::Bones' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveSpeed) == 0x000078, "Member 'FRigUnit_BoneHarmonics::WaveSpeed' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveFrequency) == 0x000084, "Member 'FRigUnit_BoneHarmonics::WaveFrequency' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveAmplitude) == 0x000090, "Member 'FRigUnit_BoneHarmonics::WaveAmplitude' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveOffset) == 0x00009C, "Member 'FRigUnit_BoneHarmonics::WaveOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveNoise) == 0x0000A8, "Member 'FRigUnit_BoneHarmonics::WaveNoise' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveEase) == 0x0000B4, "Member 'FRigUnit_BoneHarmonics::WaveEase' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveMinimum) == 0x0000B8, "Member 'FRigUnit_BoneHarmonics::WaveMinimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, WaveMaximum) == 0x0000BC, "Member 'FRigUnit_BoneHarmonics::WaveMaximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_BoneHarmonics, RotationOrder) == 0x0000C0, "Member 'FRigUnit_BoneHarmonics::RotationOrder' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SetRelativeBoneTransform) == 0x0000E0, "Wrong size on FRigUnit_SetRelativeBoneTransform");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, Bone) == 0x000068, "Member 'FRigUnit_SetRelativeBoneTransform::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, Space) == 0x000070, "Member 'FRigUnit_SetRelativeBoneTransform::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, Transform) == 0x000080, "Member 'FRigUnit_SetRelativeBoneTransform::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, Weight) == 0x0000B0, "Member 'FRigUnit_SetRelativeBoneTransform::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, bPropagateToChildren) == 0x0000B4, "Member 'FRigUnit_SetRelativeBoneTransform::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, CachedBone) == 0x0000B8, "Member 'FRigUnit_SetRelativeBoneTransform::CachedBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetRelativeBoneTransform, CachedSpaceIndex) == 0x0000CC, "Member 'FRigUnit_SetRelativeBoneTransform::CachedSpaceIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_CCDIKPerItem) == 0x000140, "Wrong size on FRigUnit_CCDIKPerItem");
static_assert(offsetof(FRigUnit_CCDIKPerItem, Items) == 0x000068, "Member 'FRigUnit_CCDIKPerItem::Items' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIKPerItem, EffectorTransform) == 0x000080, "Member 'FRigUnit_CCDIKPerItem::EffectorTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIKPerItem, Precision) == 0x0000B0, "Member 'FRigUnit_CCDIKPerItem::Precision' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIKPerItem, Weight) == 0x0000B4, "Member 'FRigUnit_CCDIKPerItem::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIKPerItem, MaxIterations) == 0x0000B8, "Member 'FRigUnit_CCDIKPerItem::MaxIterations' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIKPerItem, bStartFromTail) == 0x0000BC, "Member 'FRigUnit_CCDIKPerItem::bStartFromTail' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIKPerItem, BaseRotationLimit) == 0x0000C0, "Member 'FRigUnit_CCDIKPerItem::BaseRotationLimit' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_CCDIK) == 0x000140, "Wrong size on FRigUnit_CCDIK");
static_assert(offsetof(FRigUnit_CCDIK, StartBone) == 0x000068, "Member 'FRigUnit_CCDIK::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, EffectorBone) == 0x000070, "Member 'FRigUnit_CCDIK::EffectorBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, EffectorTransform) == 0x000080, "Member 'FRigUnit_CCDIK::EffectorTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, Precision) == 0x0000B0, "Member 'FRigUnit_CCDIK::Precision' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, Weight) == 0x0000B4, "Member 'FRigUnit_CCDIK::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, MaxIterations) == 0x0000B8, "Member 'FRigUnit_CCDIK::MaxIterations' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, bStartFromTail) == 0x0000BC, "Member 'FRigUnit_CCDIK::bStartFromTail' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, BaseRotationLimit) == 0x0000C0, "Member 'FRigUnit_CCDIK::BaseRotationLimit' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, RotationLimits) == 0x0000C8, "Member 'FRigUnit_CCDIK::RotationLimits' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, bPropagateToChildren) == 0x0000D8, "Member 'FRigUnit_CCDIK::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_CCDIK, WorkData) == 0x0000E0, "Member 'FRigUnit_CCDIK::WorkData' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_ChainHarmonics_WorkData, Items) == 0x000010, "Member 'FRigUnit_ChainHarmonics_WorkData::Items' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_ChainHarmonicsPerItem) == 0x000270, "Wrong size on FRigUnit_ChainHarmonicsPerItem");
static_assert(offsetof(FRigUnit_ChainHarmonicsPerItem, ChainRoot) == 0x000068, "Member 'FRigUnit_ChainHarmonicsPerItem::ChainRoot' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonicsPerItem, Speed) == 0x000074, "Member 'FRigUnit_ChainHarmonicsPerItem::Speed' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonicsPerItem, Reach) == 0x000080, "Member 'FRigUnit_ChainHarmonicsPerItem::Reach' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonicsPerItem, Wave) == 0x0000A8, "Member 'FRigUnit_ChainHarmonicsPerItem::Wave' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonicsPerItem, WaveCurve) == 0x0000E8, "Member 'FRigUnit_ChainHarmonicsPerItem::WaveCurve' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonicsPerItem, Pendulum) == 0x000170, "Member 'FRigUnit_ChainHarmonicsPerItem::Pendulum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonicsPerItem, bDrawDebug) == 0x0001AC, "Member 'FRigUnit_ChainHarmonicsPerItem::bDrawDebug' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_ChainHarmonics) == 0x000270, "Wrong size on FRigUnit_ChainHarmonics");
static_assert(offsetof(FRigUnit_ChainHarmonics, ChainRoot) == 0x000068, "Member 'FRigUnit_ChainHarmonics::ChainRoot' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, Speed) == 0x000070, "Member 'FRigUnit_ChainHarmonics::Speed' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, Reach) == 0x00007C, "Member 'FRigUnit_ChainHarmonics::Reach' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, Wave) == 0x0000A4, "Member 'FRigUnit_ChainHarmonics::Wave' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, WaveCurve) == 0x0000E8, "Member 'FRigUnit_ChainHarmonics::WaveCurve' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, Pendulum) == 0x000170, "Member 'FRigUnit_ChainHarmonics::Pendulum' has a wrong offset!");
static_assert(offsetof(FRigUnit_ChainHarmonics, bDrawDebug) == 0x0001AC, "Member 'FRigUnit_ChainHarmonics::bDrawDebug' has a wrong offset!");
...
static_assert(alignof(FRigUnit_CollectionBaseMutable) == 0x000008, "Wrong alignment on FRigUnit_CollectionBaseMutable");
static_assert(sizeof(FRigUnit_CollectionBaseMutable) == 0x000068, "Wrong size on FRigUnit_CollectionBaseMutable");
...
static_assert(alignof(FRigUnit_CollectionLoop) == 0x000008, "Wrong alignment on FRigUnit_CollectionLoop");
static_assert(sizeof(FRigUnit_CollectionLoop) == 0x0000F8, "Wrong size on FRigUnit_CollectionLoop");
static_assert(offsetof(FRigUnit_CollectionLoop, Collection) == 0x000068, "Member 'FRigUnit_CollectionLoop::Collection' has a wrong offset!");
static_assert(offsetof(FRigUnit_CollectionLoop, Item) == 0x000078, "Member 'FRigUnit_CollectionLoop::Item' has a wrong offset!");
static_assert(offsetof(FRigUnit_CollectionLoop, Index) == 0x000084, "Member 'FRigUnit_CollectionLoop::Index' has a wrong offset!");
static_assert(offsetof(FRigUnit_CollectionLoop, Count) == 0x000088, "Member 'FRigUnit_CollectionLoop::Count' has a wrong offset!");
static_assert(offsetof(FRigUnit_CollectionLoop, Ratio) == 0x00008C, "Member 'FRigUnit_CollectionLoop::Ratio' has a wrong offset!");
static_assert(offsetof(FRigUnit_CollectionLoop, Continue) == 0x000090, "Member 'FRigUnit_CollectionLoop::Continue' has a wrong offset!");
static_assert(offsetof(FRigUnit_CollectionLoop, Completed) == 0x000098, "Member 'FRigUnit_CollectionLoop::Completed' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_CollectionUnion) == 0x000038, "Wrong size on FRigUnit_CollectionUnion");
...
static_assert(offsetof(FRigUnit_CollectionUnion, Collection) == 0x000028, "Member 'FRigUnit_CollectionUnion::Collection' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_CollectionItems) == 0x000028, "Wrong size on FRigUnit_CollectionItems");
static_assert(offsetof(FRigUnit_CollectionItems, Items) == 0x000008, "Member 'FRigUnit_CollectionItems::Items' has a wrong offset!");
static_assert(offsetof(FRigUnit_CollectionItems, Collection) == 0x000018, "Member 'FRigUnit_CollectionItems::Collection' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugBezierItemSpace) == 0x000110, "Wrong size on FRigUnit_DebugBezierItemSpace");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, Bezier) == 0x000068, "Member 'FRigUnit_DebugBezierItemSpace::Bezier' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, MinimumU) == 0x000098, "Member 'FRigUnit_DebugBezierItemSpace::MinimumU' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, MaximumU) == 0x00009C, "Member 'FRigUnit_DebugBezierItemSpace::MaximumU' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, Color) == 0x0000A0, "Member 'FRigUnit_DebugBezierItemSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, Thickness) == 0x0000B0, "Member 'FRigUnit_DebugBezierItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, Detail) == 0x0000B4, "Member 'FRigUnit_DebugBezierItemSpace::Detail' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, Space) == 0x0000B8, "Member 'FRigUnit_DebugBezierItemSpace::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, WorldOffset) == 0x0000D0, "Member 'FRigUnit_DebugBezierItemSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezierItemSpace, bEnabled) == 0x000100, "Member 'FRigUnit_DebugBezierItemSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugBezier) == 0x000100, "Wrong size on FRigUnit_DebugBezier");
static_assert(offsetof(FRigUnit_DebugBezier, Bezier) == 0x000068, "Member 'FRigUnit_DebugBezier::Bezier' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, MinimumU) == 0x000098, "Member 'FRigUnit_DebugBezier::MinimumU' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, MaximumU) == 0x00009C, "Member 'FRigUnit_DebugBezier::MaximumU' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, Color) == 0x0000A0, "Member 'FRigUnit_DebugBezier::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, Thickness) == 0x0000B0, "Member 'FRigUnit_DebugBezier::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, Detail) == 0x0000B4, "Member 'FRigUnit_DebugBezier::Detail' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugBezier, Space) == 0x0000B8, "Member 'FRigUnit_DebugBezier::Space' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugHierarchy) == 0x0000C0, "Wrong size on FRigUnit_DebugHierarchy");
static_assert(offsetof(FRigUnit_DebugHierarchy, Scale) == 0x000068, "Member 'FRigUnit_DebugHierarchy::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugHierarchy, Color) == 0x00006C, "Member 'FRigUnit_DebugHierarchy::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugHierarchy, Thickness) == 0x00007C, "Member 'FRigUnit_DebugHierarchy::Thickness' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugLineItemSpace) == 0x0000E0, "Wrong size on FRigUnit_DebugLineItemSpace");
static_assert(offsetof(FRigUnit_DebugLineItemSpace, A) == 0x000068, "Member 'FRigUnit_DebugLineItemSpace::A' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineItemSpace, B) == 0x000074, "Member 'FRigUnit_DebugLineItemSpace::B' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineItemSpace, Color) == 0x000080, "Member 'FRigUnit_DebugLineItemSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineItemSpace, Thickness) == 0x000090, "Member 'FRigUnit_DebugLineItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineItemSpace, Space) == 0x000094, "Member 'FRigUnit_DebugLineItemSpace::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineItemSpace, WorldOffset) == 0x0000A0, "Member 'FRigUnit_DebugLineItemSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineItemSpace, bEnabled) == 0x0000D0, "Member 'FRigUnit_DebugLineItemSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugLine) == 0x0000E0, "Wrong size on FRigUnit_DebugLine");
static_assert(offsetof(FRigUnit_DebugLine, A) == 0x000068, "Member 'FRigUnit_DebugLine::A' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, B) == 0x000074, "Member 'FRigUnit_DebugLine::B' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, Color) == 0x000080, "Member 'FRigUnit_DebugLine::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, Thickness) == 0x000090, "Member 'FRigUnit_DebugLine::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, Space) == 0x000094, "Member 'FRigUnit_DebugLine::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, WorldOffset) == 0x0000A0, "Member 'FRigUnit_DebugLine::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLine, bEnabled) == 0x0000D0, "Member 'FRigUnit_DebugLine::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugLineStripItemSpace) == 0x0000E0, "Wrong size on FRigUnit_DebugLineStripItemSpace");
static_assert(offsetof(FRigUnit_DebugLineStripItemSpace, Points) == 0x000068, "Member 'FRigUnit_DebugLineStripItemSpace::Points' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStripItemSpace, Color) == 0x000078, "Member 'FRigUnit_DebugLineStripItemSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStripItemSpace, Thickness) == 0x000088, "Member 'FRigUnit_DebugLineStripItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStripItemSpace, Space) == 0x00008C, "Member 'FRigUnit_DebugLineStripItemSpace::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStripItemSpace, WorldOffset) == 0x0000A0, "Member 'FRigUnit_DebugLineStripItemSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStripItemSpace, bEnabled) == 0x0000D0, "Member 'FRigUnit_DebugLineStripItemSpace::bEnabled' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_DebugLineStrip, Points) == 0x000068, "Member 'FRigUnit_DebugLineStrip::Points' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStrip, Color) == 0x000078, "Member 'FRigUnit_DebugLineStrip::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStrip, Thickness) == 0x000088, "Member 'FRigUnit_DebugLineStrip::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugLineStrip, Space) == 0x00008C, "Member 'FRigUnit_DebugLineStrip::Space' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugPointMutable) == 0x0000E0, "Wrong size on FRigUnit_DebugPointMutable");
static_assert(offsetof(FRigUnit_DebugPointMutable, Vector) == 0x000068, "Member 'FRigUnit_DebugPointMutable::Vector' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Mode) == 0x000074, "Member 'FRigUnit_DebugPointMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Color) == 0x000078, "Member 'FRigUnit_DebugPointMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Scale) == 0x000088, "Member 'FRigUnit_DebugPointMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Thickness) == 0x00008C, "Member 'FRigUnit_DebugPointMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, Space) == 0x000090, "Member 'FRigUnit_DebugPointMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, WorldOffset) == 0x0000A0, "Member 'FRigUnit_DebugPointMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugPointMutable, bEnabled) == 0x0000D0, "Member 'FRigUnit_DebugPointMutable::bEnabled' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_DebugArcItemSpace, Transform) == 0x000070, "Member 'FRigUnit_DebugArcItemSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArcItemSpace, Color) == 0x0000A0, "Member 'FRigUnit_DebugArcItemSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArcItemSpace, Radius) == 0x0000B0, "Member 'FRigUnit_DebugArcItemSpace::Radius' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArcItemSpace, MinimumDegrees) == 0x0000B4, "Member 'FRigUnit_DebugArcItemSpace::MinimumDegrees' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArcItemSpace, MaximumDegrees) == 0x0000B8, "Member 'FRigUnit_DebugArcItemSpace::MaximumDegrees' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArcItemSpace, Thickness) == 0x0000BC, "Member 'FRigUnit_DebugArcItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArcItemSpace, Detail) == 0x0000C0, "Member 'FRigUnit_DebugArcItemSpace::Detail' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArcItemSpace, Space) == 0x0000C4, "Member 'FRigUnit_DebugArcItemSpace::Space' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugArc) == 0x000110, "Wrong size on FRigUnit_DebugArc");
static_assert(offsetof(FRigUnit_DebugArc, Transform) == 0x000070, "Member 'FRigUnit_DebugArc::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Color) == 0x0000A0, "Member 'FRigUnit_DebugArc::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Radius) == 0x0000B0, "Member 'FRigUnit_DebugArc::Radius' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, MinimumDegrees) == 0x0000B4, "Member 'FRigUnit_DebugArc::MinimumDegrees' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, MaximumDegrees) == 0x0000B8, "Member 'FRigUnit_DebugArc::MaximumDegrees' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Thickness) == 0x0000BC, "Member 'FRigUnit_DebugArc::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Detail) == 0x0000C0, "Member 'FRigUnit_DebugArc::Detail' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugArc, Space) == 0x0000C4, "Member 'FRigUnit_DebugArc::Space' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_DebugRectangleItemSpace, Transform) == 0x000070, "Member 'FRigUnit_DebugRectangleItemSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangleItemSpace, Color) == 0x0000A0, "Member 'FRigUnit_DebugRectangleItemSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangleItemSpace, Scale) == 0x0000B0, "Member 'FRigUnit_DebugRectangleItemSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangleItemSpace, Thickness) == 0x0000B4, "Member 'FRigUnit_DebugRectangleItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangleItemSpace, Space) == 0x0000B8, "Member 'FRigUnit_DebugRectangleItemSpace::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangleItemSpace, WorldOffset) == 0x0000D0, "Member 'FRigUnit_DebugRectangleItemSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangleItemSpace, bEnabled) == 0x000100, "Member 'FRigUnit_DebugRectangleItemSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugRectangle) == 0x000100, "Wrong size on FRigUnit_DebugRectangle");
static_assert(offsetof(FRigUnit_DebugRectangle, Transform) == 0x000070, "Member 'FRigUnit_DebugRectangle::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, Color) == 0x0000A0, "Member 'FRigUnit_DebugRectangle::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, Scale) == 0x0000B0, "Member 'FRigUnit_DebugRectangle::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, Thickness) == 0x0000B4, "Member 'FRigUnit_DebugRectangle::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, Space) == 0x0000B8, "Member 'FRigUnit_DebugRectangle::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, WorldOffset) == 0x0000C0, "Member 'FRigUnit_DebugRectangle::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugRectangle, bEnabled) == 0x0000F0, "Member 'FRigUnit_DebugRectangle::bEnabled' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Transforms) == 0x000068, "Member 'FRigUnit_DebugTransformArrayMutable::Transforms' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Mode) == 0x000078, "Member 'FRigUnit_DebugTransformArrayMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Color) == 0x00007C, "Member 'FRigUnit_DebugTransformArrayMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Thickness) == 0x00008C, "Member 'FRigUnit_DebugTransformArrayMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Scale) == 0x000090, "Member 'FRigUnit_DebugTransformArrayMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, Space) == 0x000094, "Member 'FRigUnit_DebugTransformArrayMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformArrayMutable, WorldOffset) == 0x0000A0, "Member 'FRigUnit_DebugTransformArrayMutable::WorldOffset' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugTransformMutableItemSpace) == 0x000110, "Wrong size on FRigUnit_DebugTransformMutableItemSpace");
static_assert(offsetof(FRigUnit_DebugTransformMutableItemSpace, Transform) == 0x000070, "Member 'FRigUnit_DebugTransformMutableItemSpace::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutableItemSpace, Mode) == 0x0000A0, "Member 'FRigUnit_DebugTransformMutableItemSpace::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutableItemSpace, Color) == 0x0000A4, "Member 'FRigUnit_DebugTransformMutableItemSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutableItemSpace, Thickness) == 0x0000B4, "Member 'FRigUnit_DebugTransformMutableItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutableItemSpace, Scale) == 0x0000B8, "Member 'FRigUnit_DebugTransformMutableItemSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutableItemSpace, Space) == 0x0000BC, "Member 'FRigUnit_DebugTransformMutableItemSpace::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutableItemSpace, WorldOffset) == 0x0000D0, "Member 'FRigUnit_DebugTransformMutableItemSpace::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutableItemSpace, bEnabled) == 0x000100, "Member 'FRigUnit_DebugTransformMutableItemSpace::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DebugTransformMutable) == 0x000110, "Wrong size on FRigUnit_DebugTransformMutable");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Transform) == 0x000070, "Member 'FRigUnit_DebugTransformMutable::Transform' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Mode) == 0x0000A0, "Member 'FRigUnit_DebugTransformMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Color) == 0x0000A4, "Member 'FRigUnit_DebugTransformMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Thickness) == 0x0000B4, "Member 'FRigUnit_DebugTransformMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Scale) == 0x0000B8, "Member 'FRigUnit_DebugTransformMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, Space) == 0x0000BC, "Member 'FRigUnit_DebugTransformMutable::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, WorldOffset) == 0x0000D0, "Member 'FRigUnit_DebugTransformMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigUnit_DebugTransformMutable, bEnabled) == 0x000100, "Member 'FRigUnit_DebugTransformMutable::bEnabled' has a wrong offset!");
...
static_assert(alignof(FRigUnit_DistributeRotationForCollection) == 0x000008, "Wrong alignment on FRigUnit_DistributeRotationForCollection");
static_assert(sizeof(FRigUnit_DistributeRotationForCollection) == 0x0000E0, "Wrong size on FRigUnit_DistributeRotationForCollection");
static_assert(offsetof(FRigUnit_DistributeRotationForCollection, Items) == 0x000068, "Member 'FRigUnit_DistributeRotationForCollection::Items' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotationForCollection, Rotations) == 0x000078, "Member 'FRigUnit_DistributeRotationForCollection::Rotations' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotationForCollection, RotationEaseType) == 0x000088, "Member 'FRigUnit_DistributeRotationForCollection::RotationEaseType' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_VisualDebugTransformItemSpace) == 0x000060, "Wrong size on FRigUnit_VisualDebugTransformItemSpace");
...
static_assert(offsetof(FRigUnit_VisualDebugTransformItemSpace, bEnabled) == 0x000040, "Member 'FRigUnit_VisualDebugTransformItemSpace::bEnabled' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugTransformItemSpace, Thickness) == 0x000044, "Member 'FRigUnit_VisualDebugTransformItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugTransformItemSpace, Scale) == 0x000048, "Member 'FRigUnit_VisualDebugTransformItemSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugTransformItemSpace, Space) == 0x00004C, "Member 'FRigUnit_VisualDebugTransformItemSpace::Space' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DistributeRotation) == 0x0000E8, "Wrong size on FRigUnit_DistributeRotation");
static_assert(offsetof(FRigUnit_DistributeRotation, StartBone) == 0x000068, "Member 'FRigUnit_DistributeRotation::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, EndBone) == 0x000070, "Member 'FRigUnit_DistributeRotation::EndBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, Rotations) == 0x000078, "Member 'FRigUnit_DistributeRotation::Rotations' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, RotationEaseType) == 0x000088, "Member 'FRigUnit_DistributeRotation::RotationEaseType' has a wrong offset!");
static_assert(offsetof(FRigUnit_DistributeRotation, Weight) == 0x00008C, "Member 'FRigUnit_DistributeRotation::Weight' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_DrawContainerSetTransform) == 0x0000A0, "Wrong size on FRigUnit_DrawContainerSetTransform");
...
static_assert(sizeof(FRigUnit_DrawContainerSetThickness) == 0x000078, "Wrong size on FRigUnit_DrawContainerSetThickness");
static_assert(offsetof(FRigUnit_DrawContainerSetThickness, InstructionName) == 0x000068, "Member 'FRigUnit_DrawContainerSetThickness::InstructionName' has a wrong offset!");
static_assert(offsetof(FRigUnit_DrawContainerSetThickness, Thickness) == 0x000070, "Member 'FRigUnit_DrawContainerSetThickness::Thickness' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_MathRBFInterpolateQuatColor) == 0x0000F0, "Wrong size on FRigUnit_MathRBFInterpolateQuatColor");
...
static_assert(offsetof(FRigUnit_VerletIntegrateVector, bInitialized) == 0x00006C, "Member 'FRigUnit_VerletIntegrateVector::bInitialized' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_FABRIKPerItem) == 0x000100, "Wrong size on FRigUnit_FABRIKPerItem");
static_assert(offsetof(FRigUnit_FABRIKPerItem, Items) == 0x000068, "Member 'FRigUnit_FABRIKPerItem::Items' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIKPerItem, EffectorTransform) == 0x000080, "Member 'FRigUnit_FABRIKPerItem::EffectorTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIKPerItem, Precision) == 0x0000B0, "Member 'FRigUnit_FABRIKPerItem::Precision' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIKPerItem, Weight) == 0x0000B4, "Member 'FRigUnit_FABRIKPerItem::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIKPerItem, bPropagateToChildren) == 0x0000B8, "Member 'FRigUnit_FABRIKPerItem::bPropagateToChildren' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_ToWorldSpace_Rotation) == 0x000030, "Wrong size on FRigUnit_ToWorldSpace_Rotation");
...
static_assert(offsetof(FRigUnit_ToWorldSpace_Rotation, World) == 0x000020, "Member 'FRigUnit_ToWorldSpace_Rotation::World' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_FABRIK) == 0x000100, "Wrong size on FRigUnit_FABRIK");
static_assert(offsetof(FRigUnit_FABRIK, StartBone) == 0x000068, "Member 'FRigUnit_FABRIK::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, EffectorBone) == 0x000070, "Member 'FRigUnit_FABRIK::EffectorBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, EffectorTransform) == 0x000080, "Member 'FRigUnit_FABRIK::EffectorTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, Precision) == 0x0000B0, "Member 'FRigUnit_FABRIK::Precision' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, Weight) == 0x0000B4, "Member 'FRigUnit_FABRIK::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_FABRIK, bPropagateToChildren) == 0x0000B8, "Member 'FRigUnit_FABRIK::bPropagateToChildren' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_FitChainToCurvePerItem) == 0x000200, "Wrong size on FRigUnit_FitChainToCurvePerItem");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, Items) == 0x000068, "Member 'FRigUnit_FitChainToCurvePerItem::Items' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, Bezier) == 0x000078, "Member 'FRigUnit_FitChainToCurvePerItem::Bezier' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, Alignment) == 0x0000A8, "Member 'FRigUnit_FitChainToCurvePerItem::Alignment' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, Minimum) == 0x0000AC, "Member 'FRigUnit_FitChainToCurvePerItem::Minimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, Maximum) == 0x0000B0, "Member 'FRigUnit_FitChainToCurvePerItem::Maximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, SamplingPrecision) == 0x0000B4, "Member 'FRigUnit_FitChainToCurvePerItem::SamplingPrecision' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, PrimaryAxis) == 0x0000B8, "Member 'FRigUnit_FitChainToCurvePerItem::PrimaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, SecondaryAxis) == 0x0000C4, "Member 'FRigUnit_FitChainToCurvePerItem::SecondaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, PoleVectorPosition) == 0x0000D0, "Member 'FRigUnit_FitChainToCurvePerItem::PoleVectorPosition' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, Rotations) == 0x0000E0, "Member 'FRigUnit_FitChainToCurvePerItem::Rotations' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, RotationEaseType) == 0x0000F0, "Member 'FRigUnit_FitChainToCurvePerItem::RotationEaseType' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, Weight) == 0x0000F4, "Member 'FRigUnit_FitChainToCurvePerItem::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurvePerItem, bPropagateToChildren) == 0x0000F8, "Member 'FRigUnit_FitChainToCurvePerItem::bPropagateToChildren' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_ToRigSpace_Rotation, Global) == 0x000020, "Member 'FRigUnit_ToRigSpace_Rotation::Global' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_FitChainToCurve) == 0x000200, "Wrong size on FRigUnit_FitChainToCurve");
static_assert(offsetof(FRigUnit_FitChainToCurve, StartBone) == 0x000068, "Member 'FRigUnit_FitChainToCurve::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, EndBone) == 0x000070, "Member 'FRigUnit_FitChainToCurve::EndBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Bezier) == 0x000078, "Member 'FRigUnit_FitChainToCurve::Bezier' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Alignment) == 0x0000A8, "Member 'FRigUnit_FitChainToCurve::Alignment' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Minimum) == 0x0000AC, "Member 'FRigUnit_FitChainToCurve::Minimum' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Maximum) == 0x0000B0, "Member 'FRigUnit_FitChainToCurve::Maximum' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, SamplingPrecision) == 0x0000B4, "Member 'FRigUnit_FitChainToCurve::SamplingPrecision' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, PrimaryAxis) == 0x0000B8, "Member 'FRigUnit_FitChainToCurve::PrimaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, SecondaryAxis) == 0x0000C4, "Member 'FRigUnit_FitChainToCurve::SecondaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, PoleVectorPosition) == 0x0000D0, "Member 'FRigUnit_FitChainToCurve::PoleVectorPosition' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Rotations) == 0x0000E0, "Member 'FRigUnit_FitChainToCurve::Rotations' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, RotationEaseType) == 0x0000F0, "Member 'FRigUnit_FitChainToCurve::RotationEaseType' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, Weight) == 0x0000F4, "Member 'FRigUnit_FitChainToCurve::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_FitChainToCurve, bPropagateToChildren) == 0x0000F8, "Member 'FRigUnit_FitChainToCurve::bPropagateToChildren' has a wrong offset!");
...
static_assert(alignof(FRigUnit_ForLoopCount) == 0x000008, "Wrong alignment on FRigUnit_ForLoopCount");
static_assert(sizeof(FRigUnit_ForLoopCount) == 0x0000D8, "Wrong size on FRigUnit_ForLoopCount");
static_assert(offsetof(FRigUnit_ForLoopCount, Count) == 0x000068, "Member 'FRigUnit_ForLoopCount::Count' has a wrong offset!");
static_assert(offsetof(FRigUnit_ForLoopCount, Index) == 0x00006C, "Member 'FRigUnit_ForLoopCount::Index' has a wrong offset!");
static_assert(offsetof(FRigUnit_ForLoopCount, Ratio) == 0x000070, "Member 'FRigUnit_ForLoopCount::Ratio' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_GetBoneTransform, CachedBone) == 0x000050, "Member 'FRigUnit_GetBoneTransform::CachedBone' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_GetControlInitialTransform) == 0x000070, "Wrong size on FRigUnit_GetControlInitialTransform");
...
static_assert(sizeof(FRigUnit_GetControlTransform) == 0x0000D0, "Wrong size on FRigUnit_GetControlTransform");
...
static_assert(sizeof(FRigUnit_GetControlRotator) == 0x000050, "Wrong size on FRigUnit_GetControlRotator");
...
static_assert(sizeof(FRigUnit_GetControlVector) == 0x000050, "Wrong size on FRigUnit_GetControlVector");
...
static_assert(sizeof(FRigUnit_GetControlVector2D) == 0x000040, "Wrong size on FRigUnit_GetControlVector2D");
...
static_assert(sizeof(FRigUnit_GetCurveValue) == 0x000028, "Wrong size on FRigUnit_GetCurveValue");
...
static_assert(sizeof(FRigUnit_GetJointTransform) == 0x0000F0, "Wrong size on FRigUnit_GetJointTransform");
static_assert(offsetof(FRigUnit_GetJointTransform, Joint) == 0x000068, "Member 'FRigUnit_GetJointTransform::Joint' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, Type) == 0x000070, "Member 'FRigUnit_GetJointTransform::Type' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, TransformSpace) == 0x000071, "Member 'FRigUnit_GetJointTransform::TransformSpace' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, BaseTransform) == 0x000080, "Member 'FRigUnit_GetJointTransform::BaseTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, BaseJoint) == 0x0000B0, "Member 'FRigUnit_GetJointTransform::BaseJoint' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetJointTransform, Output) == 0x0000C0, "Member 'FRigUnit_GetJointTransform::Output' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_GetRelativeBoneTransform) == 0x000080, "Wrong size on FRigUnit_GetRelativeBoneTransform");
...
static_assert(offsetof(FRigUnit_GetRelativeBoneTransform, CachedBone) == 0x000050, "Member 'FRigUnit_GetRelativeBoneTransform::CachedBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_GetRelativeBoneTransform, CachedSpace) == 0x000064, "Member 'FRigUnit_GetRelativeBoneTransform::CachedSpace' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_GetRelativeTransformForItem) == 0x000090, "Wrong size on FRigUnit_GetRelativeTransformForItem");
...
static_assert(sizeof(FRigUnit_GetSpaceTransform) == 0x000070, "Wrong size on FRigUnit_GetSpaceTransform");
...
static_assert(offsetof(FRigUnit_GetTransform, CachedIndex) == 0x000050, "Member 'FRigUnit_GetTransform::CachedIndex' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorBase, DistanceFunction) == 0x000014, "Member 'FRigUnit_MathRBFInterpolateVectorBase::DistanceFunction' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorBase, SmoothingFunction) == 0x000015, "Member 'FRigUnit_MathRBFInterpolateVectorBase::SmoothingFunction' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorBase, SmoothingRadius) == 0x000018, "Member 'FRigUnit_MathRBFInterpolateVectorBase::SmoothingRadius' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorBase, bNormalizeOutput) == 0x00001C, "Member 'FRigUnit_MathRBFInterpolateVectorBase::bNormalizeOutput' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorBase, WorkData) == 0x000020, "Member 'FRigUnit_MathRBFInterpolateVectorBase::WorkData' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_MathRBFInterpolateVectorColor) == 0x0000D0, "Wrong size on FRigUnit_MathRBFInterpolateVectorColor");
...
static_assert(offsetof(FRigUnit_HierarchyGetChildren, CachedChildren) == 0x000040, "Member 'FRigUnit_HierarchyGetChildren::CachedChildren' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_HierarchyGetParents, CachedParents) == 0x000040, "Member 'FRigUnit_HierarchyGetParents::CachedParents' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_MathRBFInterpolateVectorQuat) == 0x0000D0, "Wrong size on FRigUnit_MathRBFInterpolateVectorQuat");
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorQuat, Targets) == 0x0000B0, "Member 'FRigUnit_MathRBFInterpolateVectorQuat::Targets' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorQuat, Output) == 0x0000C0, "Member 'FRigUnit_MathRBFInterpolateVectorQuat::Output' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_MathRBFInterpolateVectorXform) == 0x0000F0, "Wrong size on FRigUnit_MathRBFInterpolateVectorXform");
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorXform, Targets) == 0x0000B0, "Member 'FRigUnit_MathRBFInterpolateVectorXform::Targets' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathRBFInterpolateVectorXform, Output) == 0x0000C0, "Member 'FRigUnit_MathRBFInterpolateVectorXform::Output' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_MathRBFInterpolateQuatFloat) == 0x0000F0, "Wrong size on FRigUnit_MathRBFInterpolateQuatFloat");
...
static_assert(sizeof(FRigUnit_MathRBFInterpolateVectorFloat) == 0x0000D0, "Wrong size on FRigUnit_MathRBFInterpolateVectorFloat");
...
static_assert(sizeof(FRigUnit_SlideChain) == 0x0000C8, "Wrong size on FRigUnit_SlideChain");
static_assert(offsetof(FRigUnit_SlideChain, StartBone) == 0x000068, "Member 'FRigUnit_SlideChain::StartBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChain, EndBone) == 0x000070, "Member 'FRigUnit_SlideChain::EndBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChain, SlideAmount) == 0x000078, "Member 'FRigUnit_SlideChain::SlideAmount' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChain, bPropagateToChildren) == 0x00007C, "Member 'FRigUnit_SlideChain::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChain, WorkData) == 0x000080, "Member 'FRigUnit_SlideChain::WorkData' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_MathQuaternionScale) == 0x000030, "Wrong size on FRigUnit_MathQuaternionScale");
...
static_assert(offsetof(FRigUnit_MathQuaternionScale, Scale) == 0x000020, "Member 'FRigUnit_MathQuaternionScale::Scale' has a wrong offset!");
...
static_assert(offsetof(FRigUnit_ToRigSpace_Location, Global) == 0x000014, "Member 'FRigUnit_ToRigSpace_Location::Global' has a wrong offset!");
...
static_assert(alignof(FRigUnit_SetTranslation) == 0x000008, "Wrong alignment on FRigUnit_SetTranslation");
static_assert(sizeof(FRigUnit_SetTranslation) == 0x0000A0, "Wrong size on FRigUnit_SetTranslation");
static_assert(offsetof(FRigUnit_SetTranslation, Item) == 0x000068, "Member 'FRigUnit_SetTranslation::Item' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetTranslation, Space) == 0x000074, "Member 'FRigUnit_SetTranslation::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetTranslation, Translation) == 0x000078, "Member 'FRigUnit_SetTranslation::Translation' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetTranslation, Weight) == 0x000084, "Member 'FRigUnit_SetTranslation::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetTranslation, bPropagateToChildren) == 0x000088, "Member 'FRigUnit_SetTranslation::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetTranslation, CachedIndex) == 0x00008C, "Member 'FRigUnit_SetTranslation::CachedIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_MathIntersectPlane) == 0x000048, "Wrong size on FRigUnit_MathIntersectPlane");
...
static_assert(offsetof(FRigUnit_MathIntersectPlane, Direction) == 0x000014, "Member 'FRigUnit_MathIntersectPlane::Direction' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathIntersectPlane, PlanePoint) == 0x000020, "Member 'FRigUnit_MathIntersectPlane::PlanePoint' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathIntersectPlane, PlaneNormal) == 0x00002C, "Member 'FRigUnit_MathIntersectPlane::PlaneNormal' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathIntersectPlane, Result) == 0x000038, "Member 'FRigUnit_MathIntersectPlane::Result' has a wrong offset!");
static_assert(offsetof(FRigUnit_MathIntersectPlane, Distance) == 0x000044, "Member 'FRigUnit_MathIntersectPlane::Distance' has a wrong offset!");
...
static_assert(alignof(FRigUnit_SlideChainPerItem) == 0x000008, "Wrong alignment on FRigUnit_SlideChainPerItem");
static_assert(sizeof(FRigUnit_SlideChainPerItem) == 0x0000C8, "Wrong size on FRigUnit_SlideChainPerItem");
static_assert(offsetof(FRigUnit_SlideChainPerItem, Items) == 0x000068, "Member 'FRigUnit_SlideChainPerItem::Items' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChainPerItem, SlideAmount) == 0x000078, "Member 'FRigUnit_SlideChainPerItem::SlideAmount' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChainPerItem, bPropagateToChildren) == 0x00007C, "Member 'FRigUnit_SlideChainPerItem::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SlideChainPerItem, WorkData) == 0x000080, "Member 'FRigUnit_SlideChainPerItem::WorkData' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_PointSimulation) == 0x000200, "Wrong size on FRigUnit_PointSimulation");
static_assert(offsetof(FRigUnit_PointSimulation, Points) == 0x000068, "Member 'FRigUnit_PointSimulation::Points' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, Links) == 0x000078, "Member 'FRigUnit_PointSimulation::Links' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, Forces) == 0x000088, "Member 'FRigUnit_PointSimulation::Forces' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, CollisionVolumes) == 0x000098, "Member 'FRigUnit_PointSimulation::CollisionVolumes' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, SimulatedStepsPerSecond) == 0x0000A8, "Member 'FRigUnit_PointSimulation::SimulatedStepsPerSecond' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, IntegratorType) == 0x0000AC, "Member 'FRigUnit_PointSimulation::IntegratorType' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, VerletBlend) == 0x0000B0, "Member 'FRigUnit_PointSimulation::VerletBlend' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, BoneTargets) == 0x0000B8, "Member 'FRigUnit_PointSimulation::BoneTargets' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, bLimitLocalPosition) == 0x0000C8, "Member 'FRigUnit_PointSimulation::bLimitLocalPosition' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, bPropagateToChildren) == 0x0000C9, "Member 'FRigUnit_PointSimulation::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, PrimaryAimAxis) == 0x0000CC, "Member 'FRigUnit_PointSimulation::PrimaryAimAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, SecondaryAimAxis) == 0x0000D8, "Member 'FRigUnit_PointSimulation::SecondaryAimAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_PointSimulation, DebugSettings) == 0x0000F0, "Member 'FRigUnit_PointSimulation::DebugSettings' has a wrong offset!");
...
static_assert(alignof(FRigUnit_SequenceExecution) == 0x000008, "Wrong alignment on FRigUnit_SequenceExecution");
static_assert(sizeof(FRigUnit_SequenceExecution) == 0x0001E8, "Wrong size on FRigUnit_SequenceExecution");
static_assert(offsetof(FRigUnit_SequenceExecution, ExecuteContext) == 0x000008, "Member 'FRigUnit_SequenceExecution::ExecuteContext' has a wrong offset!");
static_assert(offsetof(FRigUnit_SequenceExecution, A) == 0x000068, "Member 'FRigUnit_SequenceExecution::A' has a wrong offset!");
static_assert(offsetof(FRigUnit_SequenceExecution, B) == 0x0000C8, "Member 'FRigUnit_SequenceExecution::B' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SetControlOffset) == 0x0000C0, "Wrong size on FRigUnit_SetControlOffset");
static_assert(offsetof(FRigUnit_SetControlOffset, Control) == 0x000068, "Member 'FRigUnit_SetControlOffset::Control' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlOffset, Offset) == 0x000070, "Member 'FRigUnit_SetControlOffset::Offset' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlOffset, Space) == 0x0000A0, "Member 'FRigUnit_SetControlOffset::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlOffset, CachedControlIndex) == 0x0000A4, "Member 'FRigUnit_SetControlOffset::CachedControlIndex' has a wrong offset!");
...
static_assert(alignof(FRigUnit_SetMultiControlRotator) == 0x000008, "Wrong alignment on FRigUnit_SetMultiControlRotator");
static_assert(sizeof(FRigUnit_SetMultiControlRotator) == 0x000090, "Wrong size on FRigUnit_SetMultiControlRotator");
static_assert(offsetof(FRigUnit_SetMultiControlRotator, Entries) == 0x000068, "Member 'FRigUnit_SetMultiControlRotator::Entries' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetMultiControlRotator, Weight) == 0x000078, "Member 'FRigUnit_SetMultiControlRotator::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetMultiControlRotator, CachedControlIndices) == 0x000080, "Member 'FRigUnit_SetMultiControlRotator::CachedControlIndices' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SetControlRotator) == 0x000098, "Wrong size on FRigUnit_SetControlRotator");
static_assert(offsetof(FRigUnit_SetControlRotator, Control) == 0x000068, "Member 'FRigUnit_SetControlRotator::Control' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlRotator, Weight) == 0x000070, "Member 'FRigUnit_SetControlRotator::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlRotator, Rotator) == 0x000074, "Member 'FRigUnit_SetControlRotator::Rotator' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlRotator, Space) == 0x000080, "Member 'FRigUnit_SetControlRotator::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlRotator, CachedControlIndex) == 0x000084, "Member 'FRigUnit_SetControlRotator::CachedControlIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SetControlFloat) == 0x000090, "Wrong size on FRigUnit_SetControlFloat");
static_assert(offsetof(FRigUnit_SetControlFloat, Control) == 0x000068, "Member 'FRigUnit_SetControlFloat::Control' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlFloat, Weight) == 0x000070, "Member 'FRigUnit_SetControlFloat::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlFloat, FloatValue) == 0x000074, "Member 'FRigUnit_SetControlFloat::FloatValue' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetControlFloat, CachedControlIndex) == 0x000078, "Member 'FRigUnit_SetControlFloat::CachedControlIndex' has a wrong offset!");
...
static_assert(alignof(FRigUnit_SetScale) == 0x000008, "Wrong alignment on FRigUnit_SetScale");
static_assert(sizeof(FRigUnit_SetScale) == 0x0000A0, "Wrong size on FRigUnit_SetScale");
static_assert(offsetof(FRigUnit_SetScale, Item) == 0x000068, "Member 'FRigUnit_SetScale::Item' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetScale, Space) == 0x000074, "Member 'FRigUnit_SetScale::Space' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetScale, Scale) == 0x000078, "Member 'FRigUnit_SetScale::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetScale, Weight) == 0x000084, "Member 'FRigUnit_SetScale::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetScale, bPropagateToChildren) == 0x000088, "Member 'FRigUnit_SetScale::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_SetScale, CachedIndex) == 0x00008C, "Member 'FRigUnit_SetScale::CachedIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_TransformConstraint) == 0x000130, "Wrong size on FRigUnit_TransformConstraint");
static_assert(offsetof(FRigUnit_TransformConstraint, Bone) == 0x000068, "Member 'FRigUnit_TransformConstraint::Bone' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, BaseTransformSpace) == 0x000070, "Member 'FRigUnit_TransformConstraint::BaseTransformSpace' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, BaseTransform) == 0x000080, "Member 'FRigUnit_TransformConstraint::BaseTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, BaseBone) == 0x0000B0, "Member 'FRigUnit_TransformConstraint::BaseBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, Targets) == 0x0000B8, "Member 'FRigUnit_TransformConstraint::Targets' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, bUseInitialTransforms) == 0x0000C8, "Member 'FRigUnit_TransformConstraint::bUseInitialTransforms' has a wrong offset!");
static_assert(offsetof(FRigUnit_TransformConstraint, WorkData) == 0x0000D0, "Member 'FRigUnit_TransformConstraint::WorkData' has a wrong offset!");
...
static_assert(alignof(FRigUnit_TwistBonesPerItem) == 0x000008, "Wrong alignment on FRigUnit_TwistBonesPerItem");
static_assert(sizeof(FRigUnit_TwistBonesPerItem) == 0x0000D0, "Wrong size on FRigUnit_TwistBonesPerItem");
static_assert(offsetof(FRigUnit_TwistBonesPerItem, Items) == 0x000068, "Member 'FRigUnit_TwistBonesPerItem::Items' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBonesPerItem, TwistAxis) == 0x000078, "Member 'FRigUnit_TwistBonesPerItem::TwistAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBonesPerItem, PoleAxis) == 0x000084, "Member 'FRigUnit_TwistBonesPerItem::PoleAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBonesPerItem, TwistEaseType) == 0x000090, "Member 'FRigUnit_TwistBonesPerItem::TwistEaseType' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBonesPerItem, Weight) == 0x000094, "Member 'FRigUnit_TwistBonesPerItem::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBonesPerItem, bPropagateToChildren) == 0x000098, "Member 'FRigUnit_TwistBonesPerItem::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwistBonesPerItem, WorkData) == 0x0000A0, "Member 'FRigUnit_TwistBonesPerItem::WorkData' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_TwoBoneIKFK) == 0x000220, "Wrong size on FRigUnit_TwoBoneIKFK");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, StartJoint) == 0x000068, "Member 'FRigUnit_TwoBoneIKFK::StartJoint' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndJoint) == 0x000070, "Member 'FRigUnit_TwoBoneIKFK::EndJoint' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, PoleTarget) == 0x000078, "Member 'FRigUnit_TwoBoneIKFK::PoleTarget' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, Spin) == 0x000084, "Member 'FRigUnit_TwoBoneIKFK::Spin' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndEffector) == 0x000090, "Member 'FRigUnit_TwoBoneIKFK::EndEffector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, IKBlend) == 0x0000C0, "Member 'FRigUnit_TwoBoneIKFK::IKBlend' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, StartJointFKTransform) == 0x0000D0, "Member 'FRigUnit_TwoBoneIKFK::StartJointFKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, MidJointFKTransform) == 0x000100, "Member 'FRigUnit_TwoBoneIKFK::MidJointFKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndJointFKTransform) == 0x000130, "Member 'FRigUnit_TwoBoneIKFK::EndJointFKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, PreviousFKIKBlend) == 0x000160, "Member 'FRigUnit_TwoBoneIKFK::PreviousFKIKBlend' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, StartJointIKTransform) == 0x000170, "Member 'FRigUnit_TwoBoneIKFK::StartJointIKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, MidJointIKTransform) == 0x0001A0, "Member 'FRigUnit_TwoBoneIKFK::MidJointIKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndJointIKTransform) == 0x0001D0, "Member 'FRigUnit_TwoBoneIKFK::EndJointIKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, StartJointIndex) == 0x000200, "Member 'FRigUnit_TwoBoneIKFK::StartJointIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, MidJointIndex) == 0x000204, "Member 'FRigUnit_TwoBoneIKFK::MidJointIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndJointIndex) == 0x000208, "Member 'FRigUnit_TwoBoneIKFK::EndJointIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, UpperLimbLength) == 0x00020C, "Member 'FRigUnit_TwoBoneIKFK::UpperLimbLength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, LowerLimbLength) == 0x000210, "Member 'FRigUnit_TwoBoneIKFK::LowerLimbLength' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_TwoBoneIKSimplePerItem) == 0x0001B0, "Wrong size on FRigUnit_TwoBoneIKSimplePerItem");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, ItemA) == 0x000068, "Member 'FRigUnit_TwoBoneIKSimplePerItem::ItemA' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, ItemB) == 0x000074, "Member 'FRigUnit_TwoBoneIKSimplePerItem::ItemB' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, EffectorItem) == 0x000080, "Member 'FRigUnit_TwoBoneIKSimplePerItem::EffectorItem' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, Effector) == 0x000090, "Member 'FRigUnit_TwoBoneIKSimplePerItem::Effector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, PrimaryAxis) == 0x0000C0, "Member 'FRigUnit_TwoBoneIKSimplePerItem::PrimaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, SecondaryAxis) == 0x0000CC, "Member 'FRigUnit_TwoBoneIKSimplePerItem::SecondaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, SecondaryAxisWeight) == 0x0000D8, "Member 'FRigUnit_TwoBoneIKSimplePerItem::SecondaryAxisWeight' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, PoleVector) == 0x0000DC, "Member 'FRigUnit_TwoBoneIKSimplePerItem::PoleVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, PoleVectorKind) == 0x0000E8, "Member 'FRigUnit_TwoBoneIKSimplePerItem::PoleVectorKind' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, PoleVectorSpace) == 0x0000EC, "Member 'FRigUnit_TwoBoneIKSimplePerItem::PoleVectorSpace' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, bEnableStretch) == 0x0000F8, "Member 'FRigUnit_TwoBoneIKSimplePerItem::bEnableStretch' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, StretchStartRatio) == 0x0000FC, "Member 'FRigUnit_TwoBoneIKSimplePerItem::StretchStartRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, StretchMaximumRatio) == 0x000100, "Member 'FRigUnit_TwoBoneIKSimplePerItem::StretchMaximumRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, Weight) == 0x000104, "Member 'FRigUnit_TwoBoneIKSimplePerItem::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, ItemALength) == 0x000108, "Member 'FRigUnit_TwoBoneIKSimplePerItem::ItemALength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, ItemBLength) == 0x00010C, "Member 'FRigUnit_TwoBoneIKSimplePerItem::ItemBLength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, bPropagateToChildren) == 0x000110, "Member 'FRigUnit_TwoBoneIKSimplePerItem::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, DebugSettings) == 0x000120, "Member 'FRigUnit_TwoBoneIKSimplePerItem::DebugSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, CachedItemAIndex) == 0x000160, "Member 'FRigUnit_TwoBoneIKSimplePerItem::CachedItemAIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, CachedItemBIndex) == 0x000174, "Member 'FRigUnit_TwoBoneIKSimplePerItem::CachedItemBIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, CachedEffectorItemIndex) == 0x000188, "Member 'FRigUnit_TwoBoneIKSimplePerItem::CachedEffectorItemIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimplePerItem, CachedPoleVectorSpaceIndex) == 0x00019C, "Member 'FRigUnit_TwoBoneIKSimplePerItem::CachedPoleVectorSpaceIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_TwoBoneIKSimple) == 0x000190, "Wrong size on FRigUnit_TwoBoneIKSimple");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, BoneA) == 0x000068, "Member 'FRigUnit_TwoBoneIKSimple::BoneA' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, BoneB) == 0x000070, "Member 'FRigUnit_TwoBoneIKSimple::BoneB' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, EffectorBone) == 0x000078, "Member 'FRigUnit_TwoBoneIKSimple::EffectorBone' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, Effector) == 0x000080, "Member 'FRigUnit_TwoBoneIKSimple::Effector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, PrimaryAxis) == 0x0000B0, "Member 'FRigUnit_TwoBoneIKSimple::PrimaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, SecondaryAxis) == 0x0000BC, "Member 'FRigUnit_TwoBoneIKSimple::SecondaryAxis' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, SecondaryAxisWeight) == 0x0000C8, "Member 'FRigUnit_TwoBoneIKSimple::SecondaryAxisWeight' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, PoleVector) == 0x0000CC, "Member 'FRigUnit_TwoBoneIKSimple::PoleVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, PoleVectorKind) == 0x0000D8, "Member 'FRigUnit_TwoBoneIKSimple::PoleVectorKind' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, PoleVectorSpace) == 0x0000DC, "Member 'FRigUnit_TwoBoneIKSimple::PoleVectorSpace' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, bEnableStretch) == 0x0000E4, "Member 'FRigUnit_TwoBoneIKSimple::bEnableStretch' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, StretchStartRatio) == 0x0000E8, "Member 'FRigUnit_TwoBoneIKSimple::StretchStartRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, StretchMaximumRatio) == 0x0000EC, "Member 'FRigUnit_TwoBoneIKSimple::StretchMaximumRatio' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, Weight) == 0x0000F0, "Member 'FRigUnit_TwoBoneIKSimple::Weight' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, BoneALength) == 0x0000F4, "Member 'FRigUnit_TwoBoneIKSimple::BoneALength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, BoneBLength) == 0x0000F8, "Member 'FRigUnit_TwoBoneIKSimple::BoneBLength' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, bPropagateToChildren) == 0x0000FC, "Member 'FRigUnit_TwoBoneIKSimple::bPropagateToChildren' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, DebugSettings) == 0x000100, "Member 'FRigUnit_TwoBoneIKSimple::DebugSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, CachedBoneAIndex) == 0x000140, "Member 'FRigUnit_TwoBoneIKSimple::CachedBoneAIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, CachedBoneBIndex) == 0x000154, "Member 'FRigUnit_TwoBoneIKSimple::CachedBoneBIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, CachedEffectorBoneIndex) == 0x000168, "Member 'FRigUnit_TwoBoneIKSimple::CachedEffectorBoneIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKSimple, CachedPoleVectorSpaceIndex) == 0x00017C, "Member 'FRigUnit_TwoBoneIKSimple::CachedPoleVectorSpaceIndex' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_VisualDebugQuatItemSpace) == 0x000040, "Wrong size on FRigUnit_VisualDebugQuatItemSpace");
...
static_assert(offsetof(FRigUnit_VisualDebugQuatItemSpace, bEnabled) == 0x000020, "Member 'FRigUnit_VisualDebugQuatItemSpace::bEnabled' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugQuatItemSpace, Thickness) == 0x000024, "Member 'FRigUnit_VisualDebugQuatItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugQuatItemSpace, Scale) == 0x000028, "Member 'FRigUnit_VisualDebugQuatItemSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugQuatItemSpace, Space) == 0x00002C, "Member 'FRigUnit_VisualDebugQuatItemSpace::Space' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_VisualDebugVectorItemSpace) == 0x000040, "Wrong size on FRigUnit_VisualDebugVectorItemSpace");
...
static_assert(offsetof(FRigUnit_VisualDebugVectorItemSpace, bEnabled) == 0x000014, "Member 'FRigUnit_VisualDebugVectorItemSpace::bEnabled' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugVectorItemSpace, Mode) == 0x000015, "Member 'FRigUnit_VisualDebugVectorItemSpace::Mode' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugVectorItemSpace, Color) == 0x000018, "Member 'FRigUnit_VisualDebugVectorItemSpace::Color' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugVectorItemSpace, Thickness) == 0x000028, "Member 'FRigUnit_VisualDebugVectorItemSpace::Thickness' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugVectorItemSpace, Scale) == 0x00002C, "Member 'FRigUnit_VisualDebugVectorItemSpace::Scale' has a wrong offset!");
static_assert(offsetof(FRigUnit_VisualDebugVectorItemSpace, Space) == 0x000030, "Member 'FRigUnit_VisualDebugVectorItemSpace::Space' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_SphereTraceWorld) == 0x000048, "Wrong size on FRigUnit_SphereTraceWorld");
...
static_assert(offsetof(FRigUnit_SphereTraceWorld, End) == 0x000014, "Member 'FRigUnit_SphereTraceWorld::End' has a wrong offset!");
static_assert(offsetof(FRigUnit_SphereTraceWorld, Channel) == 0x000020, "Member 'FRigUnit_SphereTraceWorld::Channel' has a wrong offset!");
static_assert(offsetof(FRigUnit_SphereTraceWorld, Radius) == 0x000024, "Member 'FRigUnit_SphereTraceWorld::Radius' has a wrong offset!");
static_assert(offsetof(FRigUnit_SphereTraceWorld, bHit) == 0x000028, "Member 'FRigUnit_SphereTraceWorld::bHit' has a wrong offset!");
static_assert(offsetof(FRigUnit_SphereTraceWorld, HitLocation) == 0x00002C, "Member 'FRigUnit_SphereTraceWorld::HitLocation' has a wrong offset!");
static_assert(offsetof(FRigUnit_SphereTraceWorld, HitNormal) == 0x000038, "Member 'FRigUnit_SphereTraceWorld::HitNormal' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_ToWorldSpace_Location) == 0x000020, "Wrong size on FRigUnit_ToWorldSpace_Location");
...
static_assert(offsetof(FRigUnit_ToWorldSpace_Location, World) == 0x000014, "Member 'FRigUnit_ToWorldSpace_Location::World' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_ToRigSpace_Transform) == 0x000070, "Wrong size on FRigUnit_ToRigSpace_Transform");
...
static_assert(offsetof(FRigUnit_ToRigSpace_Transform, Global) == 0x000040, "Member 'FRigUnit_ToRigSpace_Transform::Global' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_ToWorldSpace_Transform) == 0x000070, "Wrong size on FRigUnit_ToWorldSpace_Transform");
...
static_assert(offsetof(FRigUnit_ToWorldSpace_Transform, World) == 0x000040, "Member 'FRigUnit_ToWorldSpace_Transform::World' has a wrong offset!");
