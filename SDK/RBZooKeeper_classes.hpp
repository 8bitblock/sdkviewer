...
public:
	...
	bool                                          bEnableSetupCommand;                               // 0x0061(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UZKAdmin, bEnableSetupCommand) == 0x000061, "Member 'UZKAdmin::bEnableSetupCommand' has a wrong offset!");
