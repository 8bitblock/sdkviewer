...
// Enum GroundBranch.EGBRestrictionType
// NumValues: 0x0007
enum class EGBRestrictionType : uint8
{
	Allow                                    = 0,
	AllowAll                                 = 1,
	AllowAny                                 = 2,
...
// ScriptStruct GroundBranch.GBRestrictionEntry
// 0x0038 (0x0038 - 0x0000)
struct FGBRestrictionEntry final
{
public:
	TArray<struct FGameplayTagContainer>          InvItemTagsList;                                   // 0x0000(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	EGBRestrictionType                            Type;                                              // 0x0010(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  TypeTags;                                          // 0x0018(0x0020)(BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGBRestrictionEntry) == 0x000008, "Wrong alignment on FGBRestrictionEntry");
static_assert(sizeof(FGBRestrictionEntry) == 0x000038, "Wrong size on FGBRestrictionEntry");
static_assert(offsetof(FGBRestrictionEntry, InvItemTagsList) == 0x000000, "Member 'FGBRestrictionEntry::InvItemTagsList' has a wrong offset!");
static_assert(offsetof(FGBRestrictionEntry, Type) == 0x000010, "Member 'FGBRestrictionEntry::Type' has a wrong offset!");
static_assert(offsetof(FGBRestrictionEntry, TypeTags) == 0x000018, "Member 'FGBRestrictionEntry::TypeTags' has a wrong offset!");

// ScriptStruct GroundBranch.GBRestrictionInfo
// 0x0020 (0x0020 - 0x0000)
struct FGBRestrictionInfo final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGBRestrictionEntry>            Entries;                                           // 0x0010(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGBRestrictionInfo) == 0x000008, "Wrong alignment on FGBRestrictionInfo");
static_assert(sizeof(FGBRestrictionInfo) == 0x000020, "Wrong size on FGBRestrictionInfo");
static_assert(offsetof(FGBRestrictionInfo, Entries) == 0x000010, "Member 'FGBRestrictionInfo::Entries' has a wrong offset!");
