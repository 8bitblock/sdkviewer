...
static_assert(offsetof(GA_AN_PEQ_IRLight_Use_C_K2_CanActivateAbility, CallFunc_IsValid_ReturnValue_1) == 0x000099, "Member 'GA_AN_PEQ_IRLight_Use_C_K2_CanActivateAbility::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
