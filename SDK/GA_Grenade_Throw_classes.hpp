...
public:
	...
	float                                         ReadyThrowDelay;                                   // 0x0440(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayTagContainer                  TagsToBlockWhileProne;                             // 0x0468(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTagContainer                  GrenadeAdjustDistanceTags;                         // 0x0488(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UGA_Grenade_Throw_C) == 0x0004A8, "Wrong size on UGA_Grenade_Throw_C");
...
static_assert(offsetof(UGA_Grenade_Throw_C, ReadyThrowDelay) == 0x000440, "Member 'UGA_Grenade_Throw_C::ReadyThrowDelay' has a wrong offset!");
...
static_assert(offsetof(UGA_Grenade_Throw_C, TagsToBlockWhileProne) == 0x000468, "Member 'UGA_Grenade_Throw_C::TagsToBlockWhileProne' has a wrong offset!");
static_assert(offsetof(UGA_Grenade_Throw_C, GrenadeAdjustDistanceTags) == 0x000488, "Member 'UGA_Grenade_Throw_C::GrenadeAdjustDistanceTags' has a wrong offset!");
