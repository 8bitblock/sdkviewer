...
void ABP_PlayerController_C::InpActEvt_NumPadZero_K2Node_InputKeyEvent_0(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PlayerController_C", "InpActEvt_NumPadZero_K2Node_InputKeyEvent_0");

	Params::BP_PlayerController_C_InpActEvt_NumPadZero_K2Node_InputKeyEvent_0 Parms{};
