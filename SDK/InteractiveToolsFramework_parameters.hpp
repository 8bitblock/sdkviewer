...
static_assert(sizeof(GizmoTransformSource_SetTransform) == 0x000030, "Wrong size on GizmoTransformSource_SetTransform");
...
static_assert(sizeof(GizmoTransformSource_GetTransform) == 0x000030, "Wrong size on GizmoTransformSource_GetTransform");
...
static_assert(alignof(GizmoAxisSource_GetDirection) == 0x000004, "Wrong alignment on GizmoAxisSource_GetDirection");
static_assert(sizeof(GizmoAxisSource_GetDirection) == 0x00000C, "Wrong size on GizmoAxisSource_GetDirection");
...
static_assert(alignof(GizmoAxisSource_GetOrigin) == 0x000004, "Wrong alignment on GizmoAxisSource_GetOrigin");
static_assert(sizeof(GizmoAxisSource_GetOrigin) == 0x00000C, "Wrong size on GizmoAxisSource_GetOrigin");
...
static_assert(alignof(GizmoAxisSource_GetTangentVectors) == 0x000004, "Wrong alignment on GizmoAxisSource_GetTangentVectors");
static_assert(sizeof(GizmoAxisSource_GetTangentVectors) == 0x000018, "Wrong size on GizmoAxisSource_GetTangentVectors");
...
static_assert(offsetof(GizmoAxisSource_GetTangentVectors, TangentYOut) == 0x00000C, "Member 'GizmoAxisSource_GetTangentVectors::TangentYOut' has a wrong offset!");
...
static_assert(alignof(GizmoVec2ParameterSource_SetParameter) == 0x000004, "Wrong alignment on GizmoVec2ParameterSource_SetParameter");
...
static_assert(alignof(GizmoVec2ParameterSource_GetParameter) == 0x000004, "Wrong alignment on GizmoVec2ParameterSource_GetParameter");
static_assert(sizeof(GizmoVec2ParameterSource_GetParameter) == 0x000008, "Wrong size on GizmoVec2ParameterSource_GetParameter");
