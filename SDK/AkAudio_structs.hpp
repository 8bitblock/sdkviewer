...
static_assert(sizeof(FAkAdvancedInitializationSettings) == 0x000030, "Wrong size on FAkAdvancedInitializationSettings");
...
static_assert(offsetof(FAkAdvancedInitializationSettings, VmPageSize) == 0x00002C, "Member 'FAkAdvancedInitializationSettings::VmPageSize' has a wrong offset!");
...
static_assert(sizeof(FAkAdvancedInitializationSettingsWithMultiCoreRendering) == 0x00003C, "Wrong size on FAkAdvancedInitializationSettingsWithMultiCoreRendering");
static_assert(offsetof(FAkAdvancedInitializationSettingsWithMultiCoreRendering, EnableMultiCoreRendering) == 0x000030, "Member 'FAkAdvancedInitializationSettingsWithMultiCoreRendering::EnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(FAkAdvancedInitializationSettingsWithMultiCoreRendering, MaxNumJobWorkers) == 0x000034, "Member 'FAkAdvancedInitializationSettingsWithMultiCoreRendering::MaxNumJobWorkers' has a wrong offset!");
static_assert(offsetof(FAkAdvancedInitializationSettingsWithMultiCoreRendering, JobWorkerMaxExecutionTimeUSec) == 0x000038, "Member 'FAkAdvancedInitializationSettingsWithMultiCoreRendering::JobWorkerMaxExecutionTimeUSec' has a wrong offset!");
...
static_assert(sizeof(FAkIOSAdvancedInitializationSettings) == 0x00003C, "Wrong size on FAkIOSAdvancedInitializationSettings");
...
static_assert(sizeof(FAkAndroidAdvancedInitializationSettings) == 0x000044, "Wrong size on FAkAndroidAdvancedInitializationSettings");
static_assert(offsetof(FAkAndroidAdvancedInitializationSettings, AudioAPI) == 0x00003C, "Member 'FAkAndroidAdvancedInitializationSettings::AudioAPI' has a wrong offset!");
static_assert(offsetof(FAkAndroidAdvancedInitializationSettings, RoundFrameSizeToHardwareSize) == 0x000040, "Member 'FAkAndroidAdvancedInitializationSettings::RoundFrameSizeToHardwareSize' has a wrong offset!");
static_assert(offsetof(FAkAndroidAdvancedInitializationSettings, bVerboseSink) == 0x000041, "Member 'FAkAndroidAdvancedInitializationSettings::bVerboseSink' has a wrong offset!");
...
{
public:
	class UAkAudioDeviceShareSet*                 AudioDeviceShareSet;                               // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAkOutputSettings) == 0x000010, "Wrong size on FAkOutputSettings");
static_assert(offsetof(FAkOutputSettings, AudioDeviceShareSet) == 0x000000, "Member 'FAkOutputSettings::AudioDeviceShareSet' has a wrong offset!");
static_assert(offsetof(FAkOutputSettings, IdDevice) == 0x000008, "Member 'FAkOutputSettings::IdDevice' has a wrong offset!");
static_assert(offsetof(FAkOutputSettings, PanRule) == 0x00000C, "Member 'FAkOutputSettings::PanRule' has a wrong offset!");
static_assert(offsetof(FAkOutputSettings, ChannelConfig) == 0x00000D, "Member 'FAkOutputSettings::ChannelConfig' has a wrong offset!");
...
static_assert(sizeof(FAkHololensAdvancedInitializationSettings) == 0x000040, "Wrong size on FAkHololensAdvancedInitializationSettings");
static_assert(offsetof(FAkHololensAdvancedInitializationSettings, UseHeadMountedDisplayAudioDevice) == 0x00003C, "Member 'FAkHololensAdvancedInitializationSettings::UseHeadMountedDisplayAudioDevice' has a wrong offset!");
...
static_assert(sizeof(FAkAcousticTextureParams) == 0x000020, "Wrong size on FAkAcousticTextureParams");
...
static_assert(alignof(FAkSurfaceEdgeInfo) == 0x000004, "Wrong alignment on FAkSurfaceEdgeInfo");
static_assert(sizeof(FAkSurfaceEdgeInfo) == 0x000028, "Wrong size on FAkSurfaceEdgeInfo");
...
static_assert(alignof(FAkSurfaceEdgeVerts) == 0x000004, "Wrong alignment on FAkSurfaceEdgeVerts");
...
static_assert(sizeof(FAkWindowsAdvancedInitializationSettings) == 0x000044, "Wrong size on FAkWindowsAdvancedInitializationSettings");
static_assert(offsetof(FAkWindowsAdvancedInitializationSettings, UseHeadMountedDisplayAudioDevice) == 0x00003C, "Member 'FAkWindowsAdvancedInitializationSettings::UseHeadMountedDisplayAudioDevice' has a wrong offset!");
static_assert(offsetof(FAkWindowsAdvancedInitializationSettings, MaxSystemAudioObjects) == 0x000040, "Member 'FAkWindowsAdvancedInitializationSettings::MaxSystemAudioObjects' has a wrong offset!");
...
static_assert(offsetof(FAkWinGDKAdvancedInitializationSettings, UseHeadMountedDisplayAudioDevice) == 0x00003C, "Member 'FAkWinGDKAdvancedInitializationSettings::UseHeadMountedDisplayAudioDevice' has a wrong offset!");
static_assert(offsetof(FAkWinGDKAdvancedInitializationSettings, uMaxSystemAudioObjects) == 0x000040, "Member 'FAkWinGDKAdvancedInitializationSettings::uMaxSystemAudioObjects' has a wrong offset!");
