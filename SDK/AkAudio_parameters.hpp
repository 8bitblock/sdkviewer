...
public:
	...
	TDelegate<void(EAkCallbackType CallbackType, class UAkCallbackInfo* CallbackInfo)> Callback;     // 0x0018(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	int32                                         CallbackMask;                                      // 0x0028(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	const class UObject*                          WorldContextObject;                                // 0x0030(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AkAudioEvent_PostAtLocation) == 0x000040, "Wrong size on AkAudioEvent_PostAtLocation");
...
static_assert(offsetof(AkAudioEvent_PostAtLocation, Orientation) == 0x00000C, "Member 'AkAudioEvent_PostAtLocation::Orientation' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_PostAtLocation, Callback) == 0x000018, "Member 'AkAudioEvent_PostAtLocation::Callback' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_PostAtLocation, CallbackMask) == 0x000028, "Member 'AkAudioEvent_PostAtLocation::CallbackMask' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_PostAtLocation, WorldContextObject) == 0x000030, "Member 'AkAudioEvent_PostAtLocation::WorldContextObject' has a wrong offset!");
static_assert(offsetof(AkAudioEvent_PostAtLocation, ReturnValue) == 0x000038, "Member 'AkAudioEvent_PostAtLocation::ReturnValue' has a wrong offset!");
